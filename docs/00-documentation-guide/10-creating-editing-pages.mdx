...
not exist for your hub/sub-hub/document, create it first, following the naming and numbering convention outlined in the [`docs/`](./04-docs-folder.mdx) section.
...
the [DOCX to MDX Converter](./05-scripts.mdx) section.
