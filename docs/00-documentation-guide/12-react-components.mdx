...
<TableVerticalNoRef
  ...
  headers={[[{ value: 'Tailwind Class' }, { value: 'Vanilla CSS Equivalent' }]]}
  columns={[
    [{ value: 'h-auto' }, { value: 'block' }, { value: 'style={{ maxWidth: width }}' }],
    [
      { value: 'height: auto;' },
      { value: 'display: block;' },
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'Extracts the current documentation path to construct the bib.json file path',
      },
      {
        value: 'Resolves the active reportId to locate the corresponding counters.json',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  headers={[
    [{ value: 'Prop' }, { value: 'Type' }, { value: 'Required' }, { value: 'Description' }],
  ]}
  columns={[
    [
      { value: 'children' },
    ...
    [{ value: 'Yes' }, { value: 'No' }, { value: 'No' }, { value: 'No' }, { value: 'No' }],
    [
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'A unique key identifying the citation in both bib.json and counters.json.',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'An object containing key-value pairs for document metadata. See below.',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'Unique key used to match the equation in counters/{reportId}.json.',
      },
      {
        value: 'A valid LaTeX string representing the equation to be rendered.',
      },
      {
        value: 'If true, renders the equation inline (default: false, renders as block).',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      ...
      {
        value: 'If true, renders inline; if false, renders as a block. Default is true.',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'Unique identifier used to retrieve the equation number from the counters file.',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  columns={[
    [{ value: 'figKey' }, { value: 'src' }, { value: 'alt' }, { value: 'caption' }],
    ...
    [
      ...
      {
        value: 'Path to the image file relative to the /RMC-Software-Documentation/ root',
      },
      {
        value: 'Alternative text for the image (used for accessibility and SEO)',
      },
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'Relative path to the image (from the /RMC-Software-Documentation/ root)',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'Unique key for the figure, matching an entry in the counters file',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      ...
      {
        value: 'The text label for the navigation link (e.g., "Back to Overview")',
      },
      {
        value: 'The identifier used by <VersionSelector /> to determine available versions',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'The relative path to the destination page (e.g., /docs/project-x/intro)',
      },
      {
...
<NavLink link="/docs/project-x/overview" linkTitle="Back to Project Overview" />;
```
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'An array of column labels (typically ["Acronym", "Definition"])',
      },
      {
        value: 'An array of arrays, where each inner array represents one column of values',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [{ value: 'Yes' }, { value: 'Yes' }, { value: 'Yes' }, { value: 'Yes' }, { value: 'Yes' }],
    [
      { value: 'Unique key used to match the table in the counters.json file' },
      {
        value: 'Array of header labels for each row (first column of the table)',
      },
      {
        value: '2D array of cell values (one array per row, excluding the header column)',
      },
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'Unique key used to locate the table number in the counters.json file',
      },
    ],
  ]}
  widthMode="intrinsic"
...
<TableVertical
  ...
  headers={[
    ...
    [{ value: null }, { value: 'Unit Weight (pcf)' }, { value: 'Permeability (cm/s)' }],
  ]}
  columns={[
    ['Clay', 'Sand', 'Gravel'],
    ['120', '110', '100'],
...
<TableVerticalNoRef
  alt="Props for the TableVerticalNoRef component"
  headers={[
    [{ value: 'Prop' }, { value: 'Type' }, { value: 'Required' }, { value: 'Description' }],
  ]}
  columns={[
...
<TableVerticalNoRef
  ...
  columns={[
    ...
    [
      {
        value: 'A unique identifier used to fetch the version list from versionList.json',
      },
    ],
  ]}
  widthMode="intrinsic"
