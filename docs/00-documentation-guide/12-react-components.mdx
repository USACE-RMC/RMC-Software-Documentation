...
such as font sizes, colors, and breakpoints - are defined in [`tailwind.config.js`](other-files#tailwind.config.js) and reused across components to ensure alignment
