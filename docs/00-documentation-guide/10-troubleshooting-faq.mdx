...
- Exact name from [Components Reference](./08-react-components.mdx)
...
- See [React Components Reference](./08-react-components.mdx)
...
2. **Verify Component Name:**
   - Check [Components Reference](./08-react-components.mdx)
...
1. See [Appendix A: Source Code Structure](./11-appendix-a-source-code-structure.mdx)
2. Test thoroughly
...
2. **Algolia Not Configured:**
   ...
   - See [Appendix B: Search Configuration](./12-appendix-b-search-configuration.mdx)
...
2. Check the [Quick Reference](./09-quick-reference.mdx)
