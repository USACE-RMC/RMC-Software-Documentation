...
|------|------|----------|---------|-------------|
| `figureKey` | String | Yes | - | Unique identifier for numbering and cross-refs |
...
**Tips:**
- Use descriptive `figureKey` values: `fig-workflow`, `fig-results-1`
...
**Usage:**
```jsx
The analysis workflow is shown in <FigureReference figureKey="fig-workflow" />.

See <FigureReference figureKey="fig-results" /> for detailed results.
```
...
| Prop | Type | Required | Description |
|------|------|----------|-------------|
| `figureKey` | String | Yes | Must match a Figure's figureKey |
...
```jsx
<FigureInline
  src="/figures/tutorial/screenshot-1.png"
  alt="Screenshot of software main window"
...
```jsx
<FigureNoRef
  src="/figures/icons/warning-icon.png"
  alt="Warning icon"
  width="100px"
/>
```
...
```jsx
<Equation
  equationKey="eq-total-risk"
  equation="R_{total} = \sum_{i=1}^{n} P_i \times C_i"
/>
```
...
<ProcessList
  items={[
    ...
    { title: 'Download the software package' },
...
**Usage:**
```jsx
<NavLink href="/docs/next-chapter">
...
```jsx
✅ Good:
<Figure figureKey="fig-workflow" ... />
<Figure figureKey="fig-results" ... />

❌ Bad:
<Figure figureKey="fig-1" ... />
<Figure figureKey="fig-1" ... />  // Duplicate key!
```
...
<Figure figureKey="fig-workflow" ... />
...
<FigureReference figureKey="fig-workflo" />  // Typo!

✅ Good:
<Figure figureKey="fig-workflow" ... />
...
<FigureReference figureKey="fig-workflow" />
```
