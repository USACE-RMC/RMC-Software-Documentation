...
**However, for documentation, use React components instead!**
...
Use colons in the separator line:
...
#### Complex Tables (Use React Components)
...
Use `<TableVertical>` or `<TableHorizontal>` components. See [React Components](./07-react-components.mdx).
...
- Props use camelCase (`figureKey` not `figure-key`)
...
- Figures: `figureKey="fig-workflow"`
...
```jsx
See <FigureReference figureKey="fig-workflow" /> for the analysis workflow.
```
...
<Figure
  figureKey="fig-workflow"
  src="/figures/workflow.png"
  alt="Flowchart showing analysis steps"
  caption="Analysis workflow diagram"
/>

## Output Visualization

<Figure
  figureKey="fig-output"
  src="/figures/output.png"
  alt="Graph showing results over time"
  caption="Model output results"
/>

## Discussion

The analysis follows the workflow shown in <FigureReference figureKey="fig-workflow" />. Results are visualized in <FigureReference figureKey="fig-output" />, demonstrating clear trends over the simulation period.
```
...
3. **Convert Documents** - Use the [DOCX Converter](./04-docx-converter.mdx) to convert Word files
