...
1. Determine folder location in `docs/` based on the hierarchy:
   - Desktop/Web Apps: application type → software name → document type → version
   - Toolbox Manuals: application type → suite name → tool name → version
