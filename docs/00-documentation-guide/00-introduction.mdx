...
- **[Appendix A: Source Code Structure](./10-appendix-a-source-code-structure.mdx)** - Deep dive into project architecture
- **[Appendix B: Build Process Overview](./11-appendix-b-build-process-overview.mdx)** - How automation scripts work behind the scenes
- **[Appendix C: Search Configuration](./12-appendix-c-search-configuration.mdx)** - Algolia search setup (admin-level)
