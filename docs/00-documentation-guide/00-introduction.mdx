...
6. **[Build Process Overview](./06-build-process-overview.mdx)** - How automation scripts work behind the scenes
7. **[Creating and Editing Pages](./07-creating-editing-pages.mdx)** - Comprehensive MDX guide with Markdown and JSX syntax
8. **[React Components](./08-react-components.mdx)** - Complete component library reference

### Reference Materials

9. **[Quick Reference](./09-quick-reference.mdx)** - Cheat sheets for common tasks
10. **[Troubleshooting & FAQ](./10-troubleshooting-faq.mdx)** - Solutions to common problems

### Appendices (Advanced Topics)

- **[Appendix A: Source Code Structure](./11-appendix-a-source-code-structure.mdx)** - Deep dive into project architecture
- **[Appendix B: Search Configuration](./12-appendix-b-search-configuration.mdx)** - Algolia search setup (admin-level)
...
3. **Step 3: Create** ([Creating and Editing Pages](./07-creating-editing-pages.mdx))
   - Learn Markdown syntax
   - Create your first MDX file
   - Import and use React components

4. **Step 4: Polish** ([React Components](./08-react-components.mdx))
   - Add figures, tables, and equations
   - Use advanced components
   - Format content professionally

5. **Ongoing:** Refer to [Quick Reference](./09-quick-reference.mdx) and [Troubleshooting](./10-troubleshooting-faq.mdx) as needed
...
- **[Troubleshooting & FAQ](./10-troubleshooting-faq.mdx)** - Solutions to common problems
- **[Quick Reference](./09-quick-reference.mdx)** - Fast lookup for common tasks
