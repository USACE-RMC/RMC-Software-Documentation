...
<b>
  The virtual environment is ONLY recommended for use inside the docx_converter folder. Do NOT
  create a virtual environment in the root of the Docusaurus project.
</b>
:::
