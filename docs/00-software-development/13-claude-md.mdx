...
**Purpose:** Shared instructions for Claude Code to ensure consistent AI-assisted development across our team

---

## Overview

This file provides instructions for Claude Code when assisting with development on USACE-RMC software projects. All developers should use this file to ensure Claude provides consistent, high-quality assistance that aligns with our team's standards and practices.
...
Our organization uses a centralized administrative model:
...
When helping write commit messages, follow our Conventional Commits standard:
...
When you discover Claude Code repeatedly:

- Makes the same mistake
- Suggests code that doesn't match our standards
- Misunderstands our tech stack
