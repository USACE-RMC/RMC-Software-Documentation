...
Goal: capture the intent of the change so teammates (and future you) can understand the progression.

- Keep it short and clear: a single sentence is fine
- Focus on **what changed** and **why**, not perfect formatting
- Use whatever structure your repo already uses (Conventional Commits optional, not required)
