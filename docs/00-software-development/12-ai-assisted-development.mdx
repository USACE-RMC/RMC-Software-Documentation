...
2. **Review generated code carefully** - Ensure it meets our standards
3. **Test AI-generated code thoroughly** - Don't assume it's correct
4. **Update the assistant guidance file (`CLAUDE.md` or `AGENT.md`)** - If you find the assistant repeatedly makes the same mistake
...
- Write your own commit messages (don't just use AI suggestions)
