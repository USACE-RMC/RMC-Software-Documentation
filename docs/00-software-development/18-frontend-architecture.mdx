...
React is a JavaScript library for building user interfaces. Instead of writing HTML pages that JavaScript manipulates, you write **components**—self-contained pieces of UI that manage their own rendering and behavior.
