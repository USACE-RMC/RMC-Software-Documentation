...
items={[
  {
    ...
    content:(
      <>
      <p>
      Team Lead for individual screenings.
      </p>
      </>
    )
  },
  {
    title:"1st Tier Reviewer", 
    content:(
      <>
      <p>
      Primary Local Review & Acceptance of Screening
      </p>
      </>
    )
  },
  {
    title:"2nd Tier Reviewer", 
    content:(
      <>
      <p>
      Review Screenings in Area of Responsibility
      </p>
      </>
    )
  },
  {
    title:"Senior Oversight Group", 
    content:(
      <>
      <p>
      Responsible for National Consistency and Recommend Risk Characterization
      </p>
      </>
    )
  },
  {
    title:"National Review Cadre",
    content:(
      <>
      <p>
      Delegated Responsibility from LSOG to provide National Consistency & Quality Assurance Reviews
      </p>
      </>
    )
  },
  {
    ...
    content:(
      <>
      <p>
      Post-LSOG Approval of Levee Screenings
      </p>
      </>
    )
  }
...
<CollectionList
items={[
  "District Levee Safety Program Managers (LSPMs) are 1st Tier Reviewers",
  "District Levee Safety Officers (LSOs) are 2nd Tier Reviewers",
  "Division LSPMs are 3rd Tier Reviewers"
]}
/>
:::
