    ...
    },
    {
      ...
      freeform:(
        ...
        items={[
          {
            title:'a)',
            child:'The adjusted SRP curve will not display greater dispersion than the base curve on which it is based. In other words, SRPs based on elicited user-input should not have more uncertainty than the base (a.k.a. average) SRP.'
          },
          {
            title: 'b)',
            child: 'The adjusted SRP curve should not show probabilities greater than zero at or below 0% load level.'
          },
          {
            title: 'c)',
            child: 'The adjusted SRP curve should match the elicited probability of failure at 100% loading.'
          },
        ]}
      />
      ...
      items={[
        {
          title: 'Consideration a)',
          child:(
            <> - assume that the variance of X equals the variance of the base curve <EquationNoRef equation = '(\sigma_{X}^2=\sigma_{Base}^2)'/></>
          ) 
        },
        {
          title: 'Consideration b)',
          child: 'assume that X is lognormally distributed'
        },
        {
          title: 'Consideration c)',
          child:(
            <> - assume the cdf of X equals the elicited probability of failure at 100% loading <EquationNoRef equation = '(P_{X=1})'/></>
          )
        },
      ]}
      />
      ...
      items={[
        {
          ...
          child:(
            <>
            <EquationNoRef equation='\frac{-\ln \left(\frac{\sigma_{Base}}{\sqrt{exp\left(\sigma_{\ln(X)^2}\right)-1}} \right) + \frac{\sigma_{\ln(X)^2}}{2} } {\sigma_{\ln(X)}} = \Phi^{-1}(P_{X=1})'/>
            </>
          )
        },
        {
...
items= {[
  {
    ...
    freeform:(
      ...
      <CollectionList
      items = {[
        'a. The levee segment has ever experienced failure due to any PFM prior to overtopping.',
        'b. Flood fighting has ever been used to prevent failure due to any PFM prior to overtopping.',
        'c. The levee has ever experienced an overtopping event.',
        'd. Flood fighting has ever been used to prevent levee overtopping.',
      ]}
      />
      </>  
    )
...
items={[
  {
   ...
   items={[
    ...
    {
      title:'Minor Slope Stability Indicators',
      content:(
        <>
        <p>
...
<Citation citationKey="Briaud2008" /> proposed categories of soil erodibility presented in terms of
flow velocity and added Unified Soil Classification Symbols for those categories in
<Citation citationKey="Briaud2019" />, as depicted in <FigReference figKey="figure-120" />. It is
...
items={[
  {
    title:'Transition wall with a stickup height less than two feet.',
    freeform:(
      <>
      <p>
  ...
  {
    title:'Transition wall that is integrated.',
    freeform:(
      <>
      <p>
  ...
  {
    title:'Gravity drainage and Pump discharge structures',
    freeform:(
      <>
      <p>
