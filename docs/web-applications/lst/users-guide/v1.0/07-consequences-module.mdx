...
the <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/structure-inventory-and-associated-properties">LifeSim Technical Reference Manual - Chapter: Structure Inventory and Associated Properties</Link>. The 
...
the <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/warning-and-protective-action-parameters#protective-action-initiation-delay">LifeSim Technical Reference Manual - Section: Protective Action Initiation Delay</Link> and <em>Mileti 
