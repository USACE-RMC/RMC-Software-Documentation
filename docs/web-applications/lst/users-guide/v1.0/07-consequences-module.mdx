...
<DocTabs
  items={[
    ...
    },
    {
      ...
      child: (
        <>
          Uses a k<sub>d</sub> value that is slightly higher than the median kd of all inorganic
...
<ProcessList
  items={[
    ...
    {
      title: 'Review the structure inventory geospatially using the map feature.',
      freeform: (
        <>
          <p>
