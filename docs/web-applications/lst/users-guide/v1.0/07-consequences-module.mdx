...
<TableVertical
  ...
  columns={[
    ...
    [
      ...
      {
        value: 'Occupancy type, designating primary building use (Technical Documentation Link)',
        rowSpan: 1,
        colSpan: 1,
      },
      {
      ...
      {
        value:
          'Primary construction materials and methods (reinforced concrete, manufactured home, masonry, steel, wood)',
        rowSpan: 1,
        colSpan: 1,
      },
