...
%%{init: {
  "theme": "neutral",
  "themeCSS": "
    .node rect, .node path, .node polygon {
    ...
    .node .label {
      fill: var(--font-color-inverse) !important;
      font-weight: 700;
      font-size: 14px;
...
flowchart LR
  A(Inundation) --> B(Structure Inventory) --> C(LifeSim Compute) --> D(Consequence Results) --> E(Critical Infrastructure)
```
...
<Tabs groupId="scenario-loads" queryString>
  <TabItem value="breach-prior" label="Breach Prior to Overtopping">
    50%, 75%, and 100% loading conditions for each breach location.
  </TabItem>
  <TabItem value="ot-breach" label="Overtopping with Breach">
    100% loading +1, +2, and +3 feet at the anticipated overtopping location.
  </TabItem>
  <TabItem value="ot-no-breach" label="Overtopping without Breach">
    100% loading +1, +2, and +3 feet at the anticipated overtopping location.
  </TabItem>
</Tabs>
...
<details>
  <summary><strong>2D flow area for river (i.e., 2D River Area)</strong></summary>
...
<details>
  <summary><strong>2D flow area for landside (i.e., 2D Modeling Area)</strong></summary>
...
<details>
  <summary><strong>2D connection for the levee (i.e., 2D Connection)</strong></summary>
...
<details>
  <summary><strong>Separate Overtopping (Optional)</strong></summary>
...
<details>
  <summary><strong>Edit In LST</strong></summary>
  The modeling area can be edited directly in the LST by clicking on the Draw/Edit Modeling Area icon
...
<details>
  <summary><strong>Upload Custom Modeling Area</strong></summary>
  When the changes required are too complex to be done in the LST, the modeling area can be edited or created externally
...
**Note:** The leveed area and 2D modeling area are initially assumed to be the same, but the model area can be adjusted in LST. The
...
<details>
  <summary><strong>Steps to complete the Structure Inventory tab</strong></summary>
...
:::note
When a screening is initially created, the LST will download data from the most recent version of the NSI. As new versions of
...
<Tabs groupId="review-structure-workflow" queryString>
  <TabItem value="base-data" label="1) Review Base Data">
    Review the <em>Base Data</em> for overall accuracy within the leveed area. The Base Data contains the total daytime and nighttime population,
  ...
  <TabItem value="summary-plots" label="2) Summary Table & Plots">
    Review the Structure Summary Table and Plots as shown in <FigReference figKey="figure-35" />. The structure summary table contains a summary of
  ...
  <TabItem value="map-viewer" label="3) Map Review">
    Review the structure inventory geospatially using the map feature. By clicking on “Map”, the structure summary table and plots will be replaced by
...
<details>
  <summary><strong>Index Factors</strong></summary>
...
<details>
  <summary><strong>Map Editor</strong></summary>
...
<details>
  <summary><strong>Upload Custom Inventory</strong></summary>
