...
<ProcessList
  items={[
    'Collect relevant levee information and review.',
    'Log in to the LST.',
    'In the list of levee segments, find the levee segment you wish to assess.',
    'Add/edit basic information about the levee segment and screening.',
    'Add/edit hydrologic and hydraulic information pertaining to the levee segment. Develop a flood loading function.',
    'Add/edit consequence information pertaining to the leveed area.',
    'Complete inundation modeling and LifeSim computation',
    'Rate the likelihood of applicable performance modes for the levee segment.',
    'Link performance modes to hazard function(s) and consequence estimates.',
    'Upload and/or identify supporting documentation. Ensure all justification fields are filled out and support the risk analysis.',
    'Review and interpret results. Develop major findings.',
    'Submit the screening to the first-tier reviewer.',
    'Review the screening and reject/approve it (through multiple levels of review).',
    'Track the screening’s status as it progresses through the review process.',
    'Respond to reviewers’ questions and comments.',
...
<ProcessList
  items={[
    { title: 'Open your web browser.' },
    {
      title: (
        <>
          Navigate to the LST’s URL:{' '}
          <Link to="https://lst2.sec.usace.army.mil/" target="_blank">
            https://lst2.sec.usace.army.mil
          </Link>
        </>
      ),
    },
    {
      ...
      freeform: [
        <>
          <p>
            To obtain a user name and password, email the LST Help Desk at{' '}
            <a href="mailto:lsthelpdesk@usace.army.mil">lsthelpdesk@usace.army.mil</a>. USACE
            personnel will route requests through the Levee Safety Program Manager (LSPM) in your
            district. You will be given a specific role for the LST (organization based: viewer,
            facilitator, 1<sup>st</sup> tier reviewer, etc., or national: Cadre, SOG, etc.), which
            will govern how you interact with the system.
          </p>
        </>,
      ],
    },
...
<DocTabs
  items={[
    {
      title: 'Help',
      child: 'Links to view and download this guide and other user aids.</>',
    },
    {
      title: 'Frequently Asked Questions (FAQs)',
      child: 'A list of frequently asked questions, organized by topic.</>',
    },
  ]}
/>
...
The Segment-Level Screening Page has four organizational levels shown in <FigReference figKey="figure-5" />:

<DocTabs
  items={[
    {
      title: 'Organizational Level',
      child: 'All levee systems in the organizational portfolio (USACE District, State, Tribe, etc. reside.',
    },
    {
      title: 'System level',
      child: 'Levee System level with name and ID as identified in the NLD.</>',
    },
    {
      title: 'Round Level',
      child: 'A round represents one instance of a risk assessment. Multiple rounds will exist over time as screening updates are done.',
    },
    {
      title: 'Segment level',
      child: 'Segment level screening.</>',
    },
  ]}
/>
...
<ProcessList
  items={[
    {
      title:
        'Click Levee Screenings at the top of the page. The Levee Screening Search page lists all the levee segments you have permission to view and/or edit.',
    },
    {
      title: (
        <>
          To search for a particular segment, use the search bar and type key words, levee name, segment/system ID number, or screening ID in the text
          box, and press “Enter” or click the magnifying glass (<FigReference figKey="figure-7" />
          ).
        </>
      ),
    },
...
<ProcessList
  items={[
    {
      title:
        'After locating the desired levee system, select “New Round” located on the same line as the levee system name and system ID. (Note: a new screening round will open all levee segments in a levee system as designated in the National Levee Database.)',
    },
    {
      title: 'The LST will prompt the following options:',
      child: [
        { title: 'Default Runs: Screening will start with default inundation model runs.' },
        {
          title:
            'Round #: Screening will start with information provided in a previously completed round. (Must have completed LST round available to be viewable.)',
        },
        { title: 'Blank: Screening will start without any previous data.' },
      ],
    },
    {
      title: 'Select the hyperlinked LS ID or the “Edit Screening” icon to open and begin editing a segment screening.',
    },
  ]}
/>
...
<CollectionList
  items={[
    { title: 'System Name and System ID' },
    { title: 'The current System LSAC' },
    { title: 'System View screen', child: 'Provides system-level summary of results.' },
    { title: 'New Round', child: 'User can open a new screening round.' },
    {
      title: 'Go to NLD',
      child: 'Sends user to the levee system NLD page to verify or update shared levee data between the NLD and LST.',
    },
  ]}
/>
...
<ProcessList
  items={[
    { title: 'Navigate to the desired levee system within the Levee Screenings page.' },
    {
      title: 'Click the "edit screening" icon of the desired levee segment (or start a new screening).',
    },
    { title: 'Click Documents in the LST module navigation bar.' },
  ]}
/>
...
Documents module, see the [Documents Module](./05-documents-module.mdx) section in this document.
...
<ProcessList
  items={[
    ...
    { title: 'Click Hazards in the LST module navigation bar.' },
  ]}
/>
  ...
  items={[
    {
      ...
      child: (
        <>
          The General Information tab prompts several questions on the hazard, data sources, and methods. To answer each of the questions, select from
          a drop-down list of options, or type your answer in a text field. Justify your answers in the appropriate Comments text field.
        </>
      ),
    },
    {
      ...
      child: (
        <>
          The Loading Function tab requires a minimum of one geo-located loading function. Select the "Add New Loading Function" button to enter a
          loading function. Complete all required data field as indicated by a red asterisk. Select the thumbtack to geo-locate a point on the levee
          alignment where the loading function applies.
        </>
      ),
    },
  ]}
...
For guidance on answering the Hydrology and Hydraulics module questions, see the [Hazards Module](./06-hazards-module.mdx) section in this document.
...
<ProcessList
  items={[
    ...
    { title: 'Click Consequences in the LST module navigation bar.' },
  ]}
/>
...
<CollectionList
  items={[
    ...
    { title: 'LifeSim Compute' },
    { title: 'Consequences Results' },
...
For guidance on using the Consequence module, see the [Consequences Module](./07-consequences-module.mdx) section in this document.
...
<DocTabs
  items={[
    {
      title: 'Inundation tab',
      child:
        'Identify breach locations for a breach prior to overtopping and overtoppingFor each breach, set hydrologic inputs and breach parameters. Run the HEC-RAS application plug-in to return inundation depths for the leveed area at various loading percentage intervals.',
    },
    {
      title: 'Structure Inventory tab',
      child:
        'Review the Structure Inventory imported from NSI. Use Index factors and/or edit the Structure Inventory to set a representative base data set of population and property values.',
    },

    {
      title: 'LifeSim Compute tab',
      child:
        'Answer emergency preparedness questions from the drop-down menu and run the Life-Sim application plug-in.',
    },
    {
      title: 'Consequence Results tab',
      child:
        'Review the consequence estimates and provide a detailed consequences narrative that tells the story of how inundation yields losses in the leveed area.',
    },
    {
      title: 'Critical Infrastructure tab',
      child:
        'Review the critical infrastructure noted in the leveed area and the inundation characteristics (depth, velocity, and arrival time). Determine any local, regional, or national impacts and document in the Critical Infrastructure text field.',
    },
...
<ProcessList
  items={[
    ...
    { title: 'Click Performance in the LST module navigation bar.' },
  ]}
/>
...
<CollectionList
  items={[
    'Answer the Historical Performance Questions',
    'Add the performance modes that are applicable to the levee segment being assessed',
    'Select and justify ratings in the Performance Metric Editor window',
    'Enter a description, add supporting images, and/or add contributing factors as needed. The contributing factors are a standardized list of influential factors commonly associated with the performance mode.',
    'To complete the risk compute, users match up the performance modes with applicable loading functions and consequences results using the drop-down menus. The drop-down menus are populated by data entered in the preceding Hazard and Consequences modules',
  ]}
/>

For guidance on using the Performance module, see the [Performance Module](./08-performance-module.mdx) section in this document.
...
<ProcessList
  items={[
    'Navigate to the desired levee system within the Levee Screenings page',
    'Click the “edit screening” icon of the desired levee segment (or start a new screening)',
    'Click Computations in the LST module navigation bar',
  ]}
/>
...
<ProcessList
  items={[
    ...
    {
      title: 'Competing Risk Model: Cumulative Incidence Functions (CIF)',
    },
    {
      title: 'APF Using adjusted SRPs',
    },
    {
      title: 'Life Loss',
    },
    {
      title: 'p(fail) _ Total Life Loss',
      child: [{ title: 'Total Expected Annual Life Loss (EALL)' }],
    },
    {
      title: 'p(fail) _ Incremental Life Loss',
      child: [{ title: 'Incremental Expected Annual Life Loss (EALL)' }],
    },
  ]}
/>

For guidance on understanding these computations, see the [Computations Module](./09-computations-module.mdx) section of this document.
...
<ProcessList
  items={[
    'Navigate to the desired levee system within the Levee Screenings page',
    'Click the “edit screening” icon of the desired levee segment (or start a new screening)',
    'Click Results in the LST module navigation bar',
  ]}
/>
...
<DocTabs
  items={[
    { title: 'Annual Probability', child: 'Annual Probability of Breach and Inundation' },
    { title: 'Expected Annual', child: 'Expected Annual Life Loss' },
    { title: 'Levee Risk', child: 'Levee (Incremental) Risk Data for Risk Matrix' },
    { title: 'Flood Risk', child: 'Flood (Total) Risk Data for Risk Matrix' },
  ]}
/>

For guidance on understanding and interpreting the results, see the [Results Module](./10-results-module.mdx) section of this document.
...
<ProcessList
  items={[
    'Navigate to the desired levee system within the Levee Screenings page',
    'Click the “edit screening” icon of the desired levee segment (or start a new screening)',
    'Click Major Findings in the LST module navigation bar',
  ]}
/>
...
<ProcessList
  items={[
    'Navigate to the desired levee system within the Levee Screenings page',
    'Click the “edit screening” icon of the desired levee segment (or start a new screening)',
    'Click Review in the LST module navigation bar',
  ]}
/>
...
<CollectionList
  items={['Executive Summary (system-level focus)', 'Risk Assessment Report (segment-level focus)']}
  layout="grid"
  columns={2}
  gridTileMinHClass="min-h-[64px]"
/>
...
<ProcessList items={['Navigate to the desired levee system within the Levee Screenings page via search bar']} />
