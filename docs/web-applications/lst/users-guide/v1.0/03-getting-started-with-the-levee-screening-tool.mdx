  ...
  items={[
    {
      ...
      content: (
        <>
          All levee systems in the organizational portfolio (USACE District, State, Tribe, etc.)
          reside.
        </>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <>
          A round represents one instance of a risk assessment. Multiple rounds will exist over time
          as screening updates are done.
        </>
      ),
    },
    {
...
<CategoryList
  ...
  items={[
    ...
    {
      title:
        'Go to NLD: sends user to the levee system NLD page to verify or update shared levee data between the NLD and LST.',
    },
  ]}
/>
...
<ProcessList
  items={[
    ...
    {
      title:
        'In the Inundation tab, identify breach locations for a breach prior to overtopping and overtopping. For each breach, set hydrologic inputs and breach parameters. Run the HEC-RAS application plug-in to return inundation depths for the leveed area at various loading percentage intervals.',
    },
    {
      title:
        'In the LifeSim Compute tab, answer emergency preparedness questions from the drop-down menu and run the Life-Sim application plug-in.',
    },
    {
      title:
        'In the Consequence Results tab, review the consequence estimates and provide a detailed consequences narrative that tells the story of how inundation yields losses in the leveed area.',
    },
    {
      title:
        'In the Critical Infrastructure tab, review the critical infrastructure noted in the leveed area and the inundation characteristics (depth, velocity, and arrival time). Determine any local, regional, or national impacts and document in the Critical Infrastructure text field.',
    },
  ]}
/>
