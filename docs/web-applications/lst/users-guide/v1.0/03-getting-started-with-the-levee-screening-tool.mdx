...
import ListBox from "@site/src/components/ListBox";
...
<a href="mailto:lsthelpdesk@usace.army.mil">lsthelpdesk@usace.army.mil</a>. USACE personnel will route requests through the
...
value: "help",
label: "Help",
content: <>Links to view and download this guide and other user aids.</>,
},
{
value: "faqs",
label: "Frequently Asked Questions (FAQs)",
content: <>A list of frequently asked questions, organized by topic.</>,
},
]}
/>
...
content: "All levee systems in the organizational portfolio (USACE District, State, Tribe, etc.) reside.",
},
{
title: "System Level",
content: "Levee System level with name and ID as identified in the NLD.",
},
{
title: "Round Level",
content:
...
{
title: "Segment Level",
content: "Segment level screening",
},
]}
/>
...
items={[
{
title: "Click Levee Screenings at the top of the page. The Levee Screening Search page lists all the levee segments you have permission to view and/or edit."
},
{
title: (
<>
To search for a particular segment, use the search bar and type key words, levee name, segment/system ID number, or screening ID in the text box,
...
<ListCards
items={[
{ title: "Systen Name and System ID"},
{ title: "The current System LSAC"},
{ title: "System View screen: Provides system-level summary of results."},
{ title: "New Round: User can open a new screening round."},
{ title: "Go to NLD: sends user to the levee system NLD page to verify or update shared levee data between the NLD and LST."}
]}
/>
...
content: <>The General Information tab prompts several questions on the hazard, data sources, and methods. To answer each of the questions, select
from a drop-down list of options, or type your answer in a text field. Justify your answers in the appropriate Comments text field.</>,
},
{
value: "loading-functions",
label: "Loading Functions",
content: <>The Loading Function tab requires a minimum of one geo-located loading function. Select the "Add New Loading Function" button to enter a
loading function. Complete all required data field as indicated by a red asterisk. Select the thumbtack to geo-locate a point on the levee alignment
where the loading function applies.</>,
},
]}
/>
...
<ListBox
items={[
{ title: "Review the Structure Inventory imported from NSI. Use Index factors and/or edit the Structure Inventory to set a representative base data set of population and property values."},
{ title: "In the Inundation tab, identify breach locations for a breach prior to overtopping and overtopping. For each breach, set hydrologic inputs and breach parameters. Run the HEC-RAS application plug-in to return inundation depths for the leveed area at various loading percentage intervals."},
{ title: "In the LifeSim Compute tab, answer emergency preparedness questions from the drop-down menu and run the Life-Sim application plug-in."},
{ title: "In the Consequence Results tab, review the consequence estimates and provide a detailed consequences narrative that tells the story of how inundation yields losses in the leveed area."},
{ title: "In the Critical Infrastructure tab, review the critical infrastructure noted in the leveed area and the inundation characteristics (depth, velocity, and arrival time). Determine any local, regional, or national impacts and document in the Critical Infrastructure text field."},
]}
/>
...
children: [
{ title: "Total Expected Annual Life Loss (EALL)"},
]
},
{
title: "p(fail) _ Incremental Life Loss",
children: [
{ title: "Incremental Expected Annual Life Loss (EALL)" },
],
},
]}
/>
