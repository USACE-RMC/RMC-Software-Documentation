  ...
  items={[
    {
      ...
      child:
        'All levee systems in the organizational portfolio (USACE District, State, Tribe, etc. reside.',
    },
    {
      title: 'System level',
    ...
    },
    {
      title: 'Round Level',
      child:
        'A round represents one instance of a risk assessment. Multiple rounds will exist over time as screening updates are done.',
    },
    {
      title: 'Segment level',
...
<ProcessList
  items={[
    ...
    },
    {
      title: (
        <>
          To search for a particular segment, use the search bar and type key words, levee name,
          segment/system ID number, or screening ID in the text box, and press “Enter” or click the
          magnifying glass (<FigReference figKey="figure-7" />
          ).
        </>
      ),
    },
...
<ProcessList
  items={[
    ...
    {
      title:
        'Select the hyperlinked LS ID or the “Edit Screening” icon to open and begin editing a segment screening.',
    },
  ]}
/>
...
<CollectionList
  items={[
    ...
    { title: 'New Round', child: 'User can open a new screening round.' },
    {
      title: 'Go to NLD',
      child:
        'Sends user to the levee system NLD page to verify or update shared levee data between the NLD and LST.',
    },
  ]}
/>
  ...
  items={[
    {
      ...
      child: (
        <>
          The General Information tab prompts several questions on the hazard, data sources, and
          methods. To answer each of the questions, select from a drop-down list of options, or type
          your answer in a text field. Justify your answers in the appropriate Comments text field.
        </>
      ),
    },
    {
      ...
      child: (
        <>
          The Loading Function tab requires a minimum of one geo-located loading function. Select
          the "Add New Loading Function" button to enter a loading function. Complete all required
          data field as indicated by a red asterisk. Select the thumbtack to geo-locate a point on
          the levee alignment where the loading function applies.
        </>
      ),
    },
  ]}
...
<ProcessList
  items={['Navigate to the desired levee system within the Levee Screenings page via search bar']}
/>
