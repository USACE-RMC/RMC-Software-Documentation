...
<TableVerticalNoRef
  alt="Three-table SRP pattern"
  headers={[[{ value: 'Table Suffix' }, { value: 'Purpose' }, { value: 'Data Source' }]]}
  columns={[
    ['_DstSrp', '_UserSrp', '_ActiveSrp'],
    ['System-Response library calculation results + nodal probability tables', 'Manually-entered SRP curve from external tools', 'Active SRP curve used in risk calculations'],
    ['Computed by DST', 'User input', 'Synced from DstSrp or UserSrp'],
  ]}
/>
...
<TableVerticalNoRef
  ...
  headers={[[{ value: 'Column' }, { value: 'Purpose' }, { value: 'Default' }, { value: 'Nullable' }]]}
  columns={[
    ['CreatedAt', 'UpdatedAt'],
    ['When the record was first created', 'When the record was last modified'],
...
<TableVerticalNoRef
  alt="Additional timestamp patterns"
  headers={[[{ value: 'Pattern' }, { value: 'Example' }, { value: 'Purpose' }]]}
  columns={[
    ['Last*At', 'LastModifiedAt', 'LastSyncedAt'],
    ['LastCalculatedAt', 'LastModifiedAt', 'LastSyncedAt'],
    ['When a specific operation was last performed', 'Domain-specific modification tracking', 'When data was last synced from another source'],
  ]}
/>
...
<TableVerticalNoRef
  alt="Migration history"
  headers={[[{ value: 'Timestamp' }, { value: 'Migration Name' }, { value: 'Tables Affected' }]]}
  columns={[
    ['20260204213854', '20260205192548', '20260206160000'],
    ['InitialCreate', 'AddScreeningEntity', 'AddMaxHazardLevelToPfm01'],
    ['Screenings, Pfm01, Pfm01_DstSrp, Pfm01_UserSrp, Pfm01_ActiveSrp', 'Screenings (restructured)', 'Pfm01 (added MaxHazardLevel column)'],
  ]}
/>
