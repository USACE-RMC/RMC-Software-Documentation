...
For complete installation instructions — including USACE App Portal steps, non-USACE download links, verifying installation, and initial Git configuration — see the [Installing Git and GitHub Desktop](/docs/dev/python-quickstart-guide/installing-git) section of the Python Quick Start Guide.
