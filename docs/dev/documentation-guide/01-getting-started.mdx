...
Contributors should focus on creating and editing documentation content using `npm start` for local testing. Site administrators will handle all building and deployment to production. See [Appendix B: Build Process Overview](./17-appendix-b-build-process-overview.mdx) for deployment details.
:::
