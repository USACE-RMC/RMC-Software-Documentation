...
Answer related threads from **Files changed** using **Start a review**, then submit the batch together. This reduces separate review submissions and notification noise, although exact GitHub email behavior depends on each user's settings. See [Reviewer Workflow §5](./12-reviewer-workflow.mdx#replying-to-comments-and-follow-up-discussion).
:::
