---
title: 'Appendix C: Search Configuration'
sidebar_label: 'Appendix C: Search'
---
...
:::info
The current configuration uses only the three required fields. Optional fields like `contextualSearch`, `searchParameters`, and `searchPagePath` can be added as needed — see the Optional Fields table below.
:::
...
<TableVerticalNoRef
  alt="Table: Field, Description, Example"
  headers={[[{ value: 'Field' }, { value: 'Description' }, { value: 'Example' }]]}
  columns={[
    ['<code>appId</code>', '<code>apiKey</code>', '<code>indexName</code>'],
    ['Algolia application ID', 'Public search-only API key', 'Name of Algolia index'],
    ['<code>&quot;5IPYQGAW1I&quot;</code>', '<code>&quot;797fecb09f4...&quot;</code>', '<code>&quot;usace-rmcio&quot;</code>'],
  ]}
/>
...
<TableVerticalNoRef
  alt="Table: Field, Description, Default"
  headers={[[{ value: 'Field' }, { value: 'Description' }, { value: 'Default' }]]}
  columns={[
    ['<code>contextualSearch</code>', '<code>searchParameters</code>', '<code>searchPagePath</code>', '<code>placeholder</code>'],
    ['Enable version/language faceting', 'Custom Algolia search parameters', 'Path to search page (false to disable)', 'Search input placeholder text'],
    ['<code>false</code>', '<code>{}</code>', '<code>&#x27;search&#x27;</code>', '<code>&#x27;Search docs...&#x27;</code>'],
  ]}
/>
...
The `scripts/versions.js` script generates three consolidated JSON files used by the site and Algolia crawler:
...
└── versions/
    ...
    ├── versionList.json            # Lists all available versions per document
    └── algoliaCrawlerVersions.json # Version metadata for the Algolia crawler
```
