...
:::note Repository-specific workflow
This chapter set is general guidance across RMC repositories. For this documentation repository, the [Documentation Guide review chapters](../documentation-guide/09-review-and-approval-overview.mdx) define the controlling classification, staged review, Director-review, publication, and deployment process.
:::
...
Repositories define review requirements through their protections and project-specific workflow. In this documentation repository, editorial, developer-documentation, and code classifications have no formal document-review stages, while documentation content follows its classification matrix.
