...
<TableVerticalNoRef
  alt="Project vs package reference methods"
  headers={[[{ value: 'Method' }, { value: 'When to Use' }, { value: 'Example' }]]}
  columns={[
    ['Project Reference', 'Package Reference'],
    ['Active development, both projects change frequently', 'Stable releases, published libraries'],
    ['Local calculation library', 'RMC.Numerics, third-party packages'],
  ]}
/>
