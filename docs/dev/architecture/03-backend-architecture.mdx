...
| Entity Framework Core | Latest  | Object-relational mapper (ORM) |
...
| **Infrastructure** | DbContext, repositories, typed HTTP clients | Implements data access and external integrations |
