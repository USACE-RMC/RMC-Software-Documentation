...
function of the system <Citation citationKey="Vose2008"/>. It is not reducible through either study or further measurement. For
...
sampling</i> approach based on procedures outlined in <Citation citationKey="NathanWeinmann2013"/> and <Citation citationKey="NathanEtAl2016"/>. The procedure involve first dividing the inflow volume-frequency curve into 50 bins uniformly spaced
...
methods: Another look at the jackknife” <Citation citationKey="Efron1979"/>. Typical applications of the bootstrap method use the
...
the parametric bootstrap, see Efron’s “An Introduction to the Bootstrap” <Citation citationKey="EfronTibshirani1998"/>.
