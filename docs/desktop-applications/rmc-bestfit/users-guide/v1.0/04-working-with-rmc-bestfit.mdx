...
<NavContainer link="/desktop-applications/rmc-bestfit" linkTitle="RMC-BestFit" document="desktop-applications/rmc-bestfit/users-guide" />
...
in <FigReference figKey="figure-43" />. The blank project is stored in your local temp directory. You may begin working with the blank
project file immediately.

<Figure
  figKey="figure-43"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure43.png"
...
<Figure
  figKey="figure-44"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure44.png"
  alt="Save Project As…."
...
shown in <FigReference figKey="figure-45" /> and <FigReference figKey="figure-46" />. If this is the first time
you're using RMC-BestFit, your recent projects list will be empty.

<Figure
  figKey="figure-45"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure45.png"
...
<Figure
  figKey="figure-46"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure46.png"
...
<Figure
  figKey="figure-47"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure47.png"
...
2. <u>Interval Data</u>: Data whose magnitudes are not known exactly, but are known to fall within a range or interval. In a maximum likelihood
   context, these values are treated as interval-censored.
...
in <FigReference figKey="figure-48" />. Next, give the **Input Data** a name and click **OK**.

<Figure
  figKey="figure-48"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure48.png"
...
systematic data, historical data dating back to 1870, and paleoflood information dating back 5,000 years. As shown in <FigReference figKey="figure-49" />,
...
<Figure
  figKey="figure-49"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure49.png"
...
exact measurements. The systematic dataset for Blakely Mountain Dam is provided in <TableReference tableKey="table-1" />. Note that the
...
in <FigReference figKey="figure-51" />. Once you have entered all of the data, you will see that the plotting positions are automatically
calculated and the data is plotted in the **Chronology** and **Frequency** plot as illustrated in <FigReference figKey="figure-52" />.

<Figure
  figKey="figure-50"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure50.png"
...
<TableVertical
  tableKey="table-1"
  headers={[[{ value: 'Year' }, { value: 'Flow (CFS)' }, { value: 'Year' }, { value: 'Flow (CFS)' }, { value: 'Year' }, { value: 'Flow (CFS)' }]]}
  columns={[
    [
      '1923',
      '1924',
...
<Figure
  figKey="figure-51"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure51.png"
...
<Figure
  figKey="figure-52"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure52.png"
  alt="Systematic Data."
...
in <FigReference figKey="figure-53" />. Clicking the **Chronology Plot** radio button will display the data in chronological order, with
...
<Figure
  figKey="figure-53"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure53.png"
...
<Figure
  figKey="figure-54"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure54.png"
...
<Figure
  figKey="figure-55"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure55.png"
...
The input data can be plotted as a **Chronology Plot** or as a nonparametric **Frequency Plot** as shown in <FigReference figKey="figure-53" />.
...
<Equation equationKey="equation-1" equation="P_i = \frac{i - α}{n + 1 - 2α}" />

where:

> _i_ = the rank of the event  
> _n_ = the sample size  
> _α_ = a constant greater than or equal to 0 and less than 1  
> _P<sub>i</sub>_ = the exceedance probability for an event with rank _i_

The value of _α_ determines how well the calculated plotting positions will fit a given theoretical probability distribution.

RMC-BestFit uses the Hirsch-Stedinger (H-S) plotting position formula (Hirsch and Stedinger, 1987) <Citation citationKey="HirschStedinger1987" /> (U.S. Geological Survey, 2018) <Citation citationKey="USGS2018" />,
...
<Figure
  figKey="figure-56"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure56.png"
...
<Figure
  figKey="figure-57"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure57.png"
...
distribution fitting and Bayesian estimation analyses. For example, if the low outlier threshold value is 8,000 and there are eight data points below
...
Interval data have magnitudes that are not known exactly, but are known to fall within a range or interval. A paleoflood study was performed for the
...
<TableVertical
  tableKey="table-2"
  headers={[[{ value: 'Year' }, { value: 'Lower' }, { value: 'Most Likely' }, { value: 'Upper' }]]}
  columns={[
    ['1020', '1882'],
    ['105,000', '66,000'],
    ['110,000', '76,000'],
...
intervals are plotted in the **Chronology** and **Frequency** plot as vertical bars (see <FigReference figKey="figure-58" />).

<Figure
  figKey="figure-58"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure58.png"
  alt="Interval Data."
...
The term _perception threshold_ originates from Bulletin 17C (U.S. Geological Survey, 2018) <Citation citationKey="USGS2018" />. For the purposes of RMC-BestFit, a **Perception Threshold**
...
There were four perception thresholds identified for the Blakely Mountain Dam 3-day inflow volume dataset (see <TableReference tableKey="table-3" />).
...
<TableVertical
  tableKey="table-3"
  headers={[[{ value: 'Start Year' }, { value: 'End Year' }, { value: 'Value' }]]}
  columns={[
    ['-2890', '1019', '1870', '1931'],
    ['1018', '1869', '1922', '1935'],
...
area (see <FigReference figKey="figure-59" />).

<Figure
  figKey="figure-59"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure59.png"
...
(see <FigReference figKey="figure-60" />). Summary statistics for the systematic data are based on the sample moments and percentile
...
distribution are estimated using numerical integration. The nonparametric distribution functions are provided in <EquationReference equationKey="equation-2" />
to <EquationReference equationKey="equation-4" />. Percentiles are estimated using the inverse cumulative distribution function
as shown in <EquationReference equationKey="equation-4" />.

<Equation equationKey="equation-2" equation="f(x) = \frac{p_{i+1} - p_i}{x_{i+1} - x_i}" />
...
<Equation equationKey="equation-4" equation="F^{-1}(p) = x_i + (x_{i+1} - x_i) \left( \frac{p - p_i}{p_{i+1} - p_i} \right)" />
...
<Figure
  figKey="figure-60"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure60.png"
...
shown in <FigReference figKey="figure-61" />. Next, give the fitting analysis a name and click **OK**.

<Figure
  figKey="figure-61"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure61.png"
...
Click the **Input Data** drop-down and select the desired data for the fitting analysis as shown in <FigReference figKey="figure-62" />.
You can set the **Output Frequency Ordinates** by clicking on the **Options** tab at the top of the **Properties Window** as shown
in <FigReference figKey="figure-63" />. The output frequency ordinates are the annual exceedance probabilities (AEP) used for
plotting the fitted distributions on the frequency plot. The default frequency ordinates range from 0.99 to 1E-6 AEP.

<Figure
  figKey="figure-62"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure62.png"
...
<Figure
  figKey="figure-63"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure63.png"
...
plotted on the **Frequency Plot** as shown in <FigReference figKey="figure-65" />.

<Figure
  figKey="figure-64"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure64.png"
...
<Figure
  figKey="figure-65"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure65.png"
...
solves for the value of the parameters that maximize the likelihood function (Rao and Hamed, 2000) <Citation citationKey="Rao2000" /> (Jongejan, 2018) <Citation citationKey="Jongejan2018" />.
...
<Equation equationKey="equation-5" equation="L_S(D \mid \theta) = \prod_{i=1}^{n_s} f(X_i \mid \theta)" />

where:

> <EquationNoRef equation="D" /> = the sample of systematically recorded annual discharge maxima <EquationNoRef equation="(X_1, \dots, X_{n_S})" />
> <EquationNoRef equation="f(∙)" /> = the probability density function (PDF) of the variable <EquationNoRef equation="X" />
...
<Equation equationKey="equation-6" equation="L_L(D \mid \theta) = \prod_{i=1}^{n_L} \binom{h}{k} F(X_0 \mid \theta)^{h - k}" />

where:

> <EquationNoRef equation="X_0" /> = the threshold
> <EquationNoRef equation="h" /> = the threshold period
> <EquationNoRef equation="k" /> = the number of observations that exceeded the threshold during the period
> <EquationNoRef equation="(h \mid k)" /> = the binomial coefficient
> <EquationNoRef equation="F(∙)" /> = the cumulative distribution function (CDF) of the variable <EquationNoRef equation="X_0" />

The binomial coefficient can be dropped from <EquationReference equationKey="equation-6" /> because it will be held constant
...
<Equation equationKey="equation-8" equation="L(D \mid \theta) = L_S(D \mid \theta) \cdot L_L(D \mid \theta) \cdot L_I(D \mid \theta)" />

These likelihood formulations for censored data are consistent with those presented
in (Stedinger, 1983) <Citation citationKey="Stedinger1983" />, (Kuczera, 1999) <Citation citationKey="Kuczera1999" />, and (O'Connell et al., 2002) <Citation citationKey="OConnell2002" />.
...
smaller value representing a better fit. The goodness-of-fit statistics are used for two purposes:

1. _Model selection_ is the process of picking one fitted distribution over another;
2. _Fit validation_ is the process of determining whether a fitted distribution agrees well with the data.
...
it is typically more severe than that of AIC. The formulas for AIC and BIC are shown in <EquationReference equationKey="equation-9" />
and <EquationReference equationKey="equation-10" />, respectively. To address potential over-fitting, RMC-BestFit implements a correction for small sample
sizes for AIC.

<Equation equationKey="equation-9" equation="AIC = 2k - 2 \ln(\hat{L}) + \frac{2k^2 + 2k}{n - k - 1}" />

<Equation equationKey="equation-10" equation="BIC = \ln(n)k - 2 \ln(\hat{L})" />

where:

> _k_ = the number of parameters  
> _n_ = the sample size  
> _L̂_ = the maximum value of the likelihood function for the model
...
<Equation equationKey="equation-11" equation="RMSE = \sqrt{\frac{\sum_{i=1}^{n} (\hat{y}_i - y_i)^2}{n}}" />

where:

> _n_ = the sample size  
> _ŷ<sub>i</sub>_ = the predicted value for item _i_  
> _y<sub>i</sub>_ = the observed value for step <i>i</i>
...
in <FigReference figKey="figure-66" />. As you move your cursor over the table, a tooltip will appear showing the fitted parameters
of the distribution as shown in <FigReference figKey="figure-67" />. You may check or uncheck distributions in this table to add or remove the
fitted distributions from the comparison plots.

<Figure
  figKey="figure-66"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure66.png"
...
<Figure
  figKey="figure-67"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure67.png"
...
distributions to the plotting positions of the input data as shown in <FigReference figKey="figure-68" />.
...
goodness-of-fit table. Then sort the RMSE column in ascending order as shown in <FigReference figKey="figure-68" />. We see that
...
<Figure
  figKey="figure-68"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure68.png"
...
in <FigReference figKey="figure-69" />. The **Frequency Plot** and **PDF Plot** are usually the most informative comparisons. With
...
<Figure
  figKey="figure-69"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure69.png"
...
in <FigReference figKey="figure-70" />. The CDF plot has a very insensitive scale, and is not very useful for comparing the
...
<Figure
  figKey="figure-70"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure70.png"
...
<Figure
  figKey="figure-71"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure71.png"
...
<Figure
  figKey="figure-72"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure72.png"
...
<Figure
  figKey="figure-73"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure73.png"
...
distribution (U.S. Geological Survey, 1982) <Citation citationKey="USGS1982" /> (U.S. Geological Survey, 2018) <Citation citationKey="USGS2018" />. As such, the PIII distribution is not considered appropriate for
...
shown in <FigReference figKey="figure-74" />. Next, give the Bayesian analysis a name and click **OK**.

<Figure
  figKey="figure-74"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure74.png"
...
data are specified, Bayes’ theorem (<EquationReference equationKey="equation-12" />) is used to combine the a priori information about the parameters
with the observed data, using the likelihood <EquationNoRef equation="P(D | θ)"/> (<EquationReference equationKey="equation-13" />).
...
<Equation equationKey="equation-13" equation="P(D \mid \theta) = \prod_{i=1}^{n} f(X_i \mid \theta)" />

where:

> <EquationNoRef equation="P(θ | D)" /> = the posterior probability density function (PDF) of <EquationNoRef equation="θ" />
> <EquationNoRef equation="P(θ)" /> = the prior PDF of <EquationNoRef equation="θ" />
> <EquationNoRef equation="P(D | θ)" /> = the likelihood function.

The posterior cumulative distribution function (CDF) of <EquationNoRef equation="X"/> now follows from the total probability theorem:

<Equation equationKey="equation-14" equation="F(X) = \int F(X \mid \theta, D) \cdot P(\theta \mid D) \, d\theta" />

which is a probability-weighted sum of the CDFs under different posterior parameter sets. <EquationReference equationKey="equation-14" /> is known as
the Bayesian posterior predictive distribution and is equivalent to the _expected probability of exceedance_ concept first presented by (Beard, 1960) <Citation citationKey="Beard1960" />.

(Stedinger, 1983) <Citation citationKey="Stedinger1983" /> and (Kuczera, 1999) <Citation citationKey="Kuczera1999" /> refer to this integral as the design flood distribution, and it
is considered the optimal estimator of an exceedance probability.

In most cases, there is not a closed form solution to the denominator of <EquationReference equationKey="equation-12" />. Therefore, Monte Carlo
...
Chain (DE-MC<sub>z</sub>) population-based sampler (ter Braak and Vrugt, 2008) <Citation citationKey="terBraak2008" />, which has proven to be very efficient at arriving at the
posterior distribution.

<FigReference figKey="figure-75" /> illustrates the basic steps in Bayesian analysis. The Bayesian approach offers a framework that is
...
along with related uncertainties (Viglione et al., 2013) <Citation citationKey="Viglione2013" />. The Bayesian approach allows you to formally include
your own expertise into the analysis by choosing _a priori_ distributions. The possibility to combine this information with the observed data is even
more important because, in practice, the observed records are usually of limited size.

<Figure
  figKey="figure-75"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure75.png"
  alt="Diagram Illustrating the Basic Steps in Bayesian Analysis."
  caption="Diagram Illustrating the Basic Steps in Bayesian Analysis."
/>
...
in <FigReference figKey="figure-76" />. Next, set the parent distribution to be the distribution selected from the **Distribution
...
<Figure
  figKey="figure-76"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure76.png"
...
within reasonable bounds without fully capturing one’s scientific knowledge about the underlying parameter (Gelman et al., 2014) <Citation citationKey="Gelman2014" />. There
are two approaches to developing a weakly informative prior as described by (Gelman et al., 2014) <Citation citationKey="Gelman2014" />:
...
The default flat priors are shown in <FigReference figKey="figure-77" />. You may uncheck the **Use Default Flat Priors** checkbox to
...
<Figure
  figKey="figure-77"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure77.png"
...
the following simulation options (see <FigReference figKey="figure-78" />) available for advanced users:

- **_Number of Chains_**: The **Bayesian Estimation Analysis** utilizes an adaptive Differential Evolution Markov Chain
  (DE-MC<sub>z</sub>) population-based sampler (ter Braak and Vrugt, 2008) <Citation citationKey="terBraak2008" />, in which multiple chains are run in parallel. It is recommended
...
- **_Jump Parameter (γ)_**: The jump parameter allows the simulation to jump from one mode region to another in the target distribution. It is recommended
  to set <EquationNoRef equation="\gamma = \frac{2.38}{\sqrt{2d}}" />, where _d_ is the number of parent distribution parameters.
...
- **_Noise Parameter (b)_**: A random noise is added to the proposal in the MCMC simulation. The noise follows a uniform distribution <EquationNoRef equation="U(-b, +b)" />.
  It is recommended that _b_ be very small, such as 0.001.
...
The **Bayesian Estimation Analysis** has the following output options (see <FigReference figKey="figure-78" />):
...
<Figure
  figKey="figure-78"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure78.png"
...
shown in <FigReference figKey="figure-79" />. When the analysis is complete, you will see the frequency curve with credible intervals appear in
**Frequency Results** plot located in the **Tabbed Documents** area.

<Figure
  figKey="figure-79"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure79.png"
...
user. However, let’s start from the bottom and work upward by first clicking on the **Markov Chain Traces** tab as shown in <FigReference figKey="figure-80" />.
...
the **Include Warm Up** checkbox, as shown in <FigReference figKey="figure-80" />.
...
<Figure
  figKey="figure-80"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure80.png"
...
Select the Autocorrelation tab and select the **Skew (of log)(γ)** parameter as shown in <FigReference figKey="figure-81" />. This plot shows the
...
<Figure
  figKey="figure-81"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure81.png"
  alt="Autocorrelation."
...
<Figure
  figKey="figure-82"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure82.png"
  alt="Mean Likelihood."
...
**Frequency Results** tab by default as shown in <FigReference figKey="figure-83" />.
...
<Figure
  figKey="figure-83"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure83.png"
...
in <FigReference figKey="figure-84" />. All of the outputted posterior parameter sets and associated log-likelihood values are available
on the **Parameter Sets** tab as shown in <FigReference figKey="figure-85" />. You may sort these tables, and copy all of the values for external
use.

<Figure
  figKey="figure-84"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure84.png"
...
<Figure
  figKey="figure-85"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure85.png"
  alt="Parameter Sets."
...
Prior Distribution** checkbox, as shown in <FigReference figKey="figure-86" />. Recall that the prior for skew was set as a uniform
...
variances (Gelman et al., 2014) <Citation citationKey="Gelman2014" />. A Rhat equal to 1.0 indicates that the posterior distribution has likely converged.

<Figure
  figKey="figure-86"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure86.png"
  alt="Kernel Density."
...
<Figure figKey="figure-87" src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure87.png" alt="Histogram." caption="Histogram." />
...
the **Y Parameter** to be **Skew (of log)(γ)**, as shown in <FigReference figKey="figure-88" />. We can see that standard deviation is negatively
...
<Figure figKey="figure-88" src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure88.png" alt="Bivariate." caption="Bivariate." />
...
modeling, or expert elicitation. In flood frequency, an example of an informative prior would be the use of a regional skew (Kuczera, 1983) <Citation citationKey="Kuczera1983" />
for the LPIII distribution as described in Bulletin 17B (U.S. Geological Survey, 1982) <Citation citationKey="USGS1982" /> and 17C (U.S. Geological Survey, 2018) <Citation citationKey="USGS2018" />.

For the Blakely Mountain Dam, regional skew information was obtained from a USGS regional study of Arkansas, Oklahoma, and Louisiana (Wagner et al., 2016) <Citation citationKey="Wagner2016" />.
...
button for the skew (of log) parameter. A distribution selector will pop open to the left of the button, as shown in <FigReference figKey="figure-89" />.

<Figure
  figKey="figure-89"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure89.png"
...
<Figure
  figKey="figure-90"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure90.png"
...
<Figure
  figKey="figure-91"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure91.png"
...
<Figure
  figKey="figure-92"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure92.png"
...
referred to as causal information expansion, which analyzes the generating mechanisms of floods in the catchment of interest (Merz and Blöschl, 2008) <Citation citationKey="MerzBloschl2008" />.
...
quantile approach, please refer to (Viglione et al., 2013) <Citation citationKey="Viglione2013" /> and (Skahill et al., 2016) <Citation citationKey="Skahill2016" />.
...
Click the distribution button and a distribution selector will pop open to the left of the button as shown in <FigReference figKey="figure-93" />.
...
in <FigReference figKey="figure-93" />.

<Figure
  figKey="figure-93"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure93.png"
...
in <FigReference figKey="figure-95" />.

<Figure
  figKey="figure-94"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure94.png"
...
<Figure
  figKey="figure-95"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure95.png"
...
<Figure
  figKey="figure-96"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure96.png"
...
distribution quantiles follows the approach used in (Coles and Tawn, 1996) <Citation citationKey="ColesTawn1996" />. The number of quantile priors must be equal to the
...
in (MetStat, Inc., 2018) <Citation citationKey="MetStat2018" />. The regional frequency analysis performed for the Trinity River Basin also included the geographical region
...
in <FigReference figKey="figure-97" />. After you have entered these prior distributions, click the **Estimate** command button
to perform the Bayesian analysis. The **Frequency Results** plot is shown below in <FigReference figKey="figure-98" />.

<Figure
  figKey="figure-97"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure97.png"
...
<Figure
  figKey="figure-98"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure98.png"
...
<Figure
  figKey="figure-99"
  src="figures/desktop-applications/rmc-bestfit/users-guide/v1.0/figure99.png"
...
on setting informative priors for quantiles, please see (Coles and Tawn, 1996) <Citation citationKey="ColesTawn1996" />, (Smith, 2005) <Citation citationKey="Smith2005" />, (Viglione et al., 2013) <Citation citationKey="Viglione2013" />, and (Skahill et al., 2016) <Citation citationKey="Skahill2016" />.
