    ...
    { // STEP 6
      title: (
        <>
          ...
          Hydrologic Engineering Center’s Flood Damage Reduction Analysis (HEC-FDA)<Citation citationKey="FDA"/>) in LifeSim to estimate expected annual life loss and how to utilize these
