...
LifeSim is designed to simulate the entire warning and evacuation process (see <FigReference figKey="figure-108"/>) for estimating potential life loss and direct economic damages resulting from
...
The LifeSim Applications Guide contains written descriptions of eight examples that demonstrate the main features of the LifeSim software. The
