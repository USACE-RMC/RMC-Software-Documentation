...
(see the <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/warning-and-protective-action-parameters#warning-and-evacuation-timeline">LifeSim Technical Reference Manual - Warning and Evacuation Timeline</Link> section for
a more detailed overview). LifeSim is 
