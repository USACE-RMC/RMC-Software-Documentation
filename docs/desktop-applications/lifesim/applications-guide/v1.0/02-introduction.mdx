...
(see the <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/preface">LifeSim Technical Reference Manual - Warning and Evacuation Timeline</Link> section for
