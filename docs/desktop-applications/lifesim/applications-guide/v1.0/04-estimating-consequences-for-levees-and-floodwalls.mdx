...
<Figure
  ...
  alt="Perception: High / Preparedness: Low Protective Action Delay Curve"
  caption="Perception: High / Preparedness: Low Protective Action Delay Curve"
/>
...
Navigate to the Map Layers pane. Right click on the structure inventory (NSI2_CacheCreek below) and select <strong>Edit</strong>. You can now edit the
...
You can export any of the four tabulated tables into various formats by clicking on the <strong>Export Table </strong>button (see below). After
