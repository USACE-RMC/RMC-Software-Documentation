...
The Import Road Network window opens (see <FigReference figKey="figure-36"/>). Map to the Road Network Shapefile by either using the dropdown (only polyline shapefiles that are in the map
