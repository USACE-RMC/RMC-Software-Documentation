...
County, CA. This levee system was originally modeled in 2021 by the U.S. Army Corps of Engineers’ (USACE)

<a href="https://mmc.sec.usace.army.mil/about-us.html" target="_blank" rel="noopener noreferrer">
...
As described in <Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/summary-of-lifesim-inputs#emergency-planning-zones">Summmary of
LifeSim Inputs, Emergency Planning Zones</Link>, EPZs are polygons that allow LifeSim to have different warning and mobilization parameters
