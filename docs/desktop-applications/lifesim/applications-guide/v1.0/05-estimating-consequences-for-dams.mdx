...
shapefile called “_City_Boundaries.shp_”. This results in 79 individual cities, which is more than we want in our simulation outputs since many of them
...
Finally, set up the non-failure alternatives. For this study we will have non-failure alternatives for only the (1) MHP Pool, (2) IHP Pool, and (3) TAS
