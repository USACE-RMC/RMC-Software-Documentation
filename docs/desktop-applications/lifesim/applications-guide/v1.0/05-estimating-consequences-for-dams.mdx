...
the <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/warning-and-protective-action-parameters">LifeSim Technical Reference Manual - Warning and Protective Action Parameters</Link> chapter
for additional information regarding the software’s default parameters and 
...
described in the <Link to="/docs/desktop-applications/lifesim/users-guide/v1.0/lifesim-interface#editor-toolbar">LifeSim Users Guide - LifeSim Interface</Link> chapter. 
