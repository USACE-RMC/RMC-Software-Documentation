...
the <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/structure-inventory-and-associated-properties#building-stability-criteria">LifeSim Technical Reference Manual - Building Stability Criteria</Link> section. As previously mentioned, because the maximum depth, maximum velocity, and 
...
<Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/estimating-consequences-for-levees-and-floodwalls/#hydraulic-data">Estimating 
 Consequences for Levees and Floodwalls, Hydraulic Data</Link>, the <Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/estimating-consequences-for-dams/#hydraulic-data">Estimating 
 Consequences for Dams, Hydraulic Data</Link>, or the <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/warning-and-protective-action-parameters#hazard-occurrence-time">LifeSim Technical Reference Manual - Hazard Occurrence Time</Link> sections
