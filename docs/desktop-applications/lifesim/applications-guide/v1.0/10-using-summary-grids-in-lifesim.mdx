...
- _.tif_ (tag image file format; an image format used for containing high quality graphics),
...
Hierarchical Data Files (_.hdf_), where the hydraulic output is broken out into specified timesteps, it is possible that depth and velocity for any given
...
Overview section (e.g., _.tif_, _.flt_, _.vrt_,) earlier in the chapter. Repeat this process for the **Maximum Velocity Grid**, which is a
...
The remaining model inputs will follow the instructions of <Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/estimating-consequences-for-levees-and-floodwalls/#purpose">
