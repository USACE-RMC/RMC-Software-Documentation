...
River Analysis System (HEC-RAS) <Citation citationKey="HECRAS2024"/>. Therefore, this approach can be useful to many LifeSim users. Allowable file types include:
...
hydraulic simulation. Maximum DxV is an important variable for stability criteria. A more detailed discussion of this topic can be found in

<Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/structure-inventory-and-associated-properties#building-stability-criteria">
  LifeSim Technical Reference Manual - Building Stability Criteria
</Link>
. As previously mentioned, because the maximum depth, maximum velocity, and maximum DxV grids are not time dependent, LifeSim cannot simulate
