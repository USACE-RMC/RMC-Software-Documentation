...
A maximum depth grid and maximum veocity grid represents the maximum depth and velocity, respectively, that occurs in each grid cell over the course
...
individuals remaining in a structure will no longer be able to evacuate on roads (i.e., a non-evacuation depth), thus they will remain in the structure and v
ertically evacuate. In the Clearwater Dam example, a non-evacuation depth of two feet (this is the standard for USACE) was used in the LifeSim model.
