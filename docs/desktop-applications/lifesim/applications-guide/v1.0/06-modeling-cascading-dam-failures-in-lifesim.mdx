...
<Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/estimating-consequences-for-dams">Estimating 
Consequences for Dams</Link> for more information). The subsequent sections discuss hydraulic data, emergency planning
...
<Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/modeling-cascading-dam-failures-in-lifesim#purpose">Purpose</Link>). To model 
...
<Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/modeling-cascading-dam-failures-in-lifesim#purpose">Purpose</Link>). Similarly, for all LifeSim models, the hazard occurrence time 
...
time selected for each hydraulic scenario. This is discussed in more detail later in
...
<ProcessList
  items={[
    { // STEP 1
      title: (
        <>
          Use the same double warning EPZ as the standard hydraulic scenario (see <Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/estimating-consequences-for-dams/#emergency-planning-zones">Estimating Consequences for Dams, Emergency Planning Zones</Link>).
        </>
      ),
    },
    { // STEP 2
...
<Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/estimating-consequences-for-dams">Estimating 
Consequences for Dams</Link> for more detailed information on
...
Consequences for Levees and Floodwalls, Understanding and Interpreting Results</Link> and
...
Consequences for Dams, Editing the Structure Inventory Based on Simulation Results</Link> for additional information on interpreting results 
