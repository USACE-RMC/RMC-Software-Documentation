...
<TableAcronyms
  ...
  columns={[
    [
      "AEP", "CFCC", "EAD", "EALL", "EMA", "EOE","EPZ", "FWOP", "FWP", "GIS", "GUI", 
    ...
    [
      ...
      "Expected Annual Damages", "Expected Annual Life Loss", "Emergency Management Agency", "Expert Opinion Elicitation", "Emergency Planning Zone", 
      "Future Without-Project", "Future With-Project", "Geographic Information System", "Graphical User Interface", 
      ...
      "Levee Screening Tool", "Maximum High Pool", "Modeling, Mapping, and Consequence", "Normal High Pool", "National Levee Database", 
      "National Structure Inventory", "OpenStreetMap", "Protective Action Initiation", "Population at Risk", "Project Delivery Team", 
