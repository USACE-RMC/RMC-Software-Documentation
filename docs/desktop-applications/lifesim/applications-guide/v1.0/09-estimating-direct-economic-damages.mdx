...
<Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/using-summary-grids-in-lifesim/#purpose">Using Summary Grids in LifeSim</Link>) and
other hydraulic models could be utilized in LifeSim (reference <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/hydraulic-data">LifeSim Technical Reference Manual - Hydraulic Data</Link> and
...
the HEC-RAS terrain HDF file are needed for each hydraulic scenario. Reference
...
Consequences for Levees and Floodwalls, Structure Inventory</Link>.
...
Consequences for Levees and Floodwalls, Understanding and Interpreting Results</Link> for additional information on understanding and interpreting your results.
