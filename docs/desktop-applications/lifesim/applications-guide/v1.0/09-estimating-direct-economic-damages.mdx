...
damages and life loss in one LifeSim model. However, summary grids (reference

<Link to="/docs/desktop-applications/lifesim/applications-guide/v1.0/using-summary-grids-in-lifesim/#purpose">Using Summary Grids in LifeSim</Link>)
and other hydraulic models could be utilized in LifeSim (reference
...
The HEC-RAS plan HDF file and the HEC-RAS terrain HDF file are needed for each hydraulic scenario. Reference
...
For information on importing a structure inventory, refer to
...
for additional information on understanding and interpreting your results.
