...
<Link to="/docs/desktop-applications/lifesim/users-guide/v1.0/hydraulic-data">LifeSim Users Guide - Hydraulic Data</Link> section.
...
By default, LifeSim uses the 40 occupancy types from Hazus (listed and described below) <Citation citationKey="FEMA2025"/>, although they can be customized. The user can also add new
...
for different areas, communities, or counties. Refer to 
the <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/warning-and-protective-action-parameters">LifeSim Technical Reference Manual - Warning and Protective Action Parameters</Link> chapter for 
