...
{/*Should the below section just read, "The emergency planning zone (EPZ) is set to one area that covers the entirety of NOLA East Bowl."*/}
...
{/*Where were the First alert and PAI curves elicited from?*/}
