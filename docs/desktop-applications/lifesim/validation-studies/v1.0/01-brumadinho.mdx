...
## <a href="https://www.rmc.usace.army.mil/Software/LifeSim/" target="_blank" rel="noopener noreferrer">*Download Model*</a>
...
The following provides a short description of the data sources used for validation. All data sources contributing to the model and documentation are detailed in the Morrill-Winter & Johnstone 2025
abstract <Citation citationKey="MorrillWinter2025"/>.
...
More structures, outdoor areas, and details were then added using pre-failure Google and Esri satellite imagery, and OSM basemap sources. Multiple structure 
