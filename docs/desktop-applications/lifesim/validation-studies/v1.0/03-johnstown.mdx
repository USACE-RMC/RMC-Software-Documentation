...
(Kaktins et al., 2013; Coleman et al., 2016) <Citation citationKey="Kaktins2013"/> <Citation citationKey="Coleman2016"/>. The model was used to simulate the South Fork Dam breach, 
...
For a detailed account of HDR’s hydraulic data collection effort, see the *South Fork Dam Failure Case Study* inundation modeling report (HDR, 2022) <Citation citationKey="HDR2022"/>.
...
- The South Fork Dam failure that caused the devastating flooding of Johnstown, PA in 1889 was the deadliest dam failure in the history of the United States. 
