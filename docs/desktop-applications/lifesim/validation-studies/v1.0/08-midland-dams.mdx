...
Edenville Dam and (subsequently) Sanford Dam in Midland County, Michigan, United States.

<Button href="https://mmc.sec.usace.army.mil/lifesim/MidlandDams_Validation_v215.zip"><u>🡇</u> Download Model</Button>
...
failure of Edenville Dam in Edenville, MI (<FigReference figKey="figure-9"/>) and the subsequent failure of Sanford Dam in Sanford, MI (<FigReference figKey="figure-10"/>),
on May 19, 2020. The two dam failures and resultant flooding triggered evacuation of approximately 11,000 people in the Midland County area.
...
The complete Midland Dams validation study analysis is documented in *Midland MI Dam Failures Case History - Hydraulic and Consequence Modeling* <Citation citationKey="HDR2021"/>. 
...
In this model, **Warning Issuance Delay** and **First Alert** are considered together for all EPZs without uncertainty, to arrive at the known warning issuance time. 
...
The model’s life loss (compared to the real event’s zero fatalities) is primarily located in hot spots shown in <FigReference figKey="figure-11"/>.

<Figure
  figKey="figure-11"
  src="figures/desktop-applications/lifesim/validation-studies/v1.0/figures/figure10.png"
  alt="Map of LifeSim model life loss locations."
  caption={
    <>
...
the following two areas received an early warning with successful evacuation, contributing to the difference between estimated model life loss and zero real-event 
fatalities. 
  ...
  [
    {
      title:[
        <>
        "Sturgeon Creek Area" (<FigReference figKey="figure-11"/>): W Main St and an adjacent neighborhood northeast of Northwood University.
        </>
      ]
    },
    {
      title:[
        <>
        "Poseyville Dike Area" (<FigReference figKey="figure-11"/>): Industrial area along Venture Dr and S Poseyville Rd.
        </>
      ]
    }
  ]
