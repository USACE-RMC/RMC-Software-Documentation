...
(USGS, 1978 <Citation citationKey="USGS1978"/>). The town of Wilford, Idaho, was destroyed. The town of Sugar City, Idaho, was devastated by a wall of water 15-feet high and moving 10 to 15 miles 
an hour. Eventually, the flood spread out eight miles wide as it approached and flooded Rexburg, Idaho. Estimated economic damages ranged from hundreds of 
...
The following provides a short description of the data sources used for validation. All data sources contributing to the model and documentation are 
detailed in McMaster (2022) <Citation citationKey="McMaster2022"/>.
...
Idaho. The 2D modeling results were then provided to USACE as input for consequence analysis using LifeSim.
...
around 90% mobilized by the time water reaches Wilford, Idaho. The custom curves were used to validate the software. These custom curves are compared against 
...
(see <FigReference figKey="teton-evac"/> below).
