...
<Button href="https://mmc.sec.usace.army.mil/lifesim/Joso_Validation_v215.zip"><u>🡇</u> Download Model</Button>
...
National and local government agencies responded by performing thousands of rescues by air (<FigReference figKey="figure-4"/>), 
...
Calibration focused on arrival time and maximum depth – the two criteria most important to evacuation and life loss modeling. Velocities were also spot checked where 
...
The population estimate for Jōsō-shi started with 2010 adjusted census data at the neighborhood level (Statistics Bureau, 2015; GIAJ, 2014) <Citation citationKey="StatisticsBureau2015"/> <Citation citationKey="GIAJ2014"/>. It was indexed 
...
Additionally, the following lessons were identified:
...
items={[
  {
    title:[
      <>
        Evacuation orders should consider the expected movement of floodwaters, and be coordinated with neighboring jurisdictions as early as possible. Warnings were sent haphazardly 
  ...
  },
  {
    title:[
      <>
      Video and photos taken during the breach event were very valuable to post-event analysis of the hazard and consequence research including breach erosion progression. Efforts 
  ...
  },
  {
    title:[
      <>
      Although National government agencies knew of the levee and river status before and during the event, the local government agency was not able to evacuate residents in time. 
      This was due to both inadequate communication between agencies, and lack of capability at the local level to interpret the available information and take
      action. <a href="https://mainichi.jp/english/articles/20170528/p2a/00m/0na/004000c" target="_blank" rel="noopener noreferrer">Since the incident, the Federal government has taken the initiative to communicate river conditions 
  ...
  },
  {
    title:[
      <>
       A detailed breach and flood hydraulics model, coupled with an agent-based evacuation and consequence model provided valuable insight to the hazard progression and damages. 
