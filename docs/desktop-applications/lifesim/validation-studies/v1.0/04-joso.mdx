...
All data sources contributing to the model and documentation are detailed in Risher et al (2017) <Citation citationKey="Risher2017"/>. Excerpts from this report are used 
to describe the model data.
