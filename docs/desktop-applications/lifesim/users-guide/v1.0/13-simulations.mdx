...
{"\n"}<FigReference figKey="figure-184" />). [Create a Simulation](./14-simulations.mdx#create-a-simulation) and [Simulation – Computation Engine
Options](./14-simulations.mdx#simulation-compuation-engine-options) cover all of the data items that can be edited by the user.
