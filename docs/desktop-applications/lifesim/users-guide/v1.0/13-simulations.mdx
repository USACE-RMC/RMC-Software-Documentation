  ...
  items={[
    {
      ...
      title: (
        <>
          ...
          <FigReference figKey="figure-181" /> demonstrates both methods.
        </>
      ),
      freeform: (
        <>
    ...
    },
    {
      ...
      title: (
        <>
          In the <strong>Hazard Occurrence Time(s) of Day</strong> box (<FigReference figKey="figure-182" />
    ...
    },
    {
      ...
      title: (
        <>
          In the <strong>Number of Iterations</strong> box (<FigReference figKey="figure-182" />
    ...
    },
    {
      ...
      title: (
        <>
          The <strong>Summary Polygons</strong> list (<FigReference figKey="figure-182" />) allows the user to set the attribute field containing
          ...
          <br />
          <br />
          Select the <strong>Summary Polygons</strong> from the dropdown list (<FigReference figKey="figure-182" />
          ...
          <strong>Summary Polygons</strong> list (<FigReference figKey="figure-183" />) updates with the desired shapefile.
        </>
      ),
      freeform: (
        <>
    ...
    },
    {
      ...
      title: (
        <>
          Enter the <strong>Summary Set Name</strong> for the zones (e.g., <strong>EPZ</strong> in <FigReference figKey="figure-183" />
    ...
    },
    {
      ...
      title: (
        <>
          From the <strong>Summary Name Field</strong> dropdown list (<FigReference figKey="figure-183" />
          ...
          message window opens (<FigReference figKey="figure-184" />) requesting the user to select a field containing unique names.
        </>
      ),
      freeform: (
        <>
    ...
    },
    {
      ...
      title: (
        <>
          ...
          <FigReference figKey="figure-183" />) to add and define another summary set. Click the <strong>Delete</strong>{' '}
          <FigureInline src="figures/desktop-applications/lifesim/users-guide/v1.0/inline-images/inline-occ-delete.png" /> button (
          <FigReference figKey="figure-183" />) to delete an added summary set.
        </>
      ),
    },
    {
      ...
      title: (
        <>
          From the <strong>Alternatives</strong> box (<FigReference figKey="figure-183" />
    ...
    },
    {
      ...
      title: (
        <>
          ...
          <FigReference figKey="figure-183" />) will close. From the LifeSim main window, from the <em>Study Tree</em>, under the{' '}
...
<strong>Road</strong> <strong>Summary</strong> <strong>Results</strong> (<FigReference figKey="figure-185" />) options are turned on
  ...
  items={[
    {
      ...
      title: (
        <>
          From the <em>Create New Simulation</em> dialog box (or from the <em>Simulation Editor</em> [<FigReference figKey="figure-187" />
          ]), click the <strong>Options</strong> menu at the top left, then click <strong>Computation Engine Options</strong> (
          <FigReference figKey="computation-opt" />
          ).
        </>
      ),
      freeform: (
    ...
    },
    {
      ...
      title: (
        <>
          ...
          (e.g., <strong>16</strong> in <FigReference figKey="figure-185" />
          ).
        </>
      ),
    },
...
Either way, the _Simulation Editor_ opens (<FigReference figKey="figure-187" />). Sections [Create a Simulation](./13-simulations.mdx#create-a-simulation) and [Simulation – Computation
