...
If traffic is being simulated (set from the Emergency Planning Zone Editor; see section [EPZ Editor](./07-emergency-planning-data.mdx#emergency-planning-zone-epz-editor)), road network data
and destination data (see section [Destination Data](./09-destination-data.mdx)) are required in a LifeSim study to represent possible
...
C](./19-appendix-editing-road-network-data-for-use-in-lifesim.mdx)).
...
[Appendix C](./19-appendix-editing-road-network-data-for-use-in-lifesim.mdx) is designed to help users
prepare and edit road networks for use in LifeSim. 
The <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/road-networks-destinations-and-evacuation-parameters">LifeSim Technical Reference Manual - Chapter: Road Networks, Destinations, and Evacuation Parameters</Link> describes 
...
data to a LifeSim study and only one format is supported (polygon shapefiles) to be utilized in LifeSim simulations.
...
<ProcessList
  items={[
    { // STEP 1
      title: (
        <>
          ...
          Data</strong> (<FigReference figKey="figure-145" />). The <em>Road Classification Editor</em> (<FigReference figKey="figure-146" />) opens.
        </>
      ),
      freeform: (
        <>
    ...
    { // STEP 2
      title: (
        <>
          ...
          Editor</em> (<FigReference figKey="figure-146" />). Review <Link to="/docs/desktop-applications/lifesim/users-guide/v1.0/lifesim-interface#customizing-plots-and-plotting-tools">Customizing
          Plots and Plotting Tools</Link> for
      ...
      title: (
        <>
          ...
          <p style={{ marginBottom: "0" }}>
            To add a new road classification code, right-click a cell to open the shortcut menu (<FigReference figKey="figure-146" />). From the shortcut menu,
            click <strong>Add Row(s)</strong>. By default, one row is added to the bottom of the road classification table (<FigReference figKey="figure-147" />).
          </p>
        </>
      ),
      freeform: (
    ...
    { // STEP 5
      title: (
        <>
          Errors in the road classification table are highlighted in red (<FigReference figKey="figure-147" />) and a tooltip displays a message describing
          the error. Right-click on a header row to open the shortcut menu (<FigReference figKey="figure-108" />) to sort the table in ascending or descending
    ...
    { // STEP 6
      title: (
        <>
          ...
          window (e.g., <strong>A48</strong> in <FigReference figKey="figure-146" />). Double-click the desired cell to edit the information for the selected CFCC
          code.
        </>
      ),
    },
    { // STEP 7
      title: (
        <>
          Click <strong>OK</strong>. The <em>Road Classification Editor</em> (<FigReference figKey="figure-146" />) closes and saves all edits to
          road classification data.
        </>
      ),
    }
...
<ProcessList
  items={[
    { // STEP 1
      title: (
        <>
          ...
          to <strong>Road Network Data</strong> (<FigReference figKey="figure-148" />), and click <strong>Import From Shapefile</strong>. Another way is
          ...
          menu (<FigReference figKey="figure-149" />), click <strong>Import Road Network From Shapefile</strong>. 
        </>
      ),
      freeform: (
        <>
    ...
    { // STEP 2
      title: (
        <>
          ...
          box (<FigReference figKey="figure-150" />) will open.
        </>
      ),
      freeform: (
        <>
    ...
    { // STEP 3
      title: (
        <>
          Enter a name for the road network dataset in the <strong>Name</strong> box (<FigReference figKey="figure-150" />).
        </>
      ),
    },
    { // STEP 4
      title: (
        <>
          ...
          menu (<FigReference figKey="figure-150" />), click <FigureInline src="figures/desktop-applications/lifesim/users-guide/v1.0/inline-images/inline-output-file.png" />. An <em>Open</em> browser 
          window (<FigReference figKey="figure-151" />) opens; navigate to
          ...
          returned to the <em>Import Road Network</em> dialog box (<FigReference figKey="figure-150" />). The location and name of the selected polyline shapefile 
    ...
    { // STEP 5
      title: (
        <>
          ...
          selected shapefile that lists the CFCC codes (e.g., <strong>CFCC</strong> in <FigReference figKey="figure-152" />). The CFCC field is used
          ...
          See <Link to="/docs/desktop-applications/lifesim/users-guide/v1.0/appendix-map-preferences#map-layer-attributes-dialog-box">Map Layer
          Attributes Dialog Box</Link> for details on accessing the attribute
          table to determine which column header contains the CFCC road identifications (e.g., A73, A15, A63, etc.). 
          Review <Link to="#road-classification-data">Road
          Classification Data</Link> for more information regarding the default CFCC codes in LifeSim.
        </>
      ),
      freeform: (
        <>
    ...
    { // STEP 6
      title: (
        <>
          ...
          provided in <FigReference figKey="figure-152" />, the <strong>One-Way Field (optional)</strong> attribute is <strong>oneway</strong>, and 
    ...
    { // STEP 7
      title: (
        <>
          ...
          menu (<FigReference figKey="figure-152" />), which sets the vertical offset.
        </>
      ),
    },
    { // STEP 8
      title: (
        <>
          ...
          (e.g., <strong>US Customary</strong> is selected in <FigReference figKey="figure-152" />).
        </>
      ),
    },
    { // STEP 9
      title: (
        <>
          Once all of the information has been entered, click <strong>OK</strong>. The <em>Import Road Network</em> dialog (<FigReference figKey="figure-152" />) will 
...
<ProcessList
  items={[
    { // STEP 1
      title: (
        <>
          ...
          Data</strong> (<FigReference figKey="figure-148" />), and click <strong>Import From OpenStreetMap</strong>.
          Another way is from the <strong>Study</strong> tab, from the <em>Study Tree</em>,
          right-click on <strong>Road Networks</strong>. From the shortcut menu (<FigReference figKey="figure-149" />), click <strong>Import Road Network From
    ...
    { // STEP 2
      title: (
        <>
          Either way, the <em>Import Road Network From OpenStreetMap</em> dialog box (<FigReference figKey="figure-153" />) opens. Enter the name of
    ...
    { // STEP 3
      title: (
        <>
          ...
          Shapefile</strong> dropdown menu (<FigReference figKey="figure-153" />). Otherwise, click 
          the <FigureInline src="figures/desktop-applications/lifesim/users-guide/v1.0/inline-images/inline-output-file.png"/> button. 
          An <em>Open</em> browser window (<FigReference figKey="figure-151" />) opens. Navigate to the directory where the bounding polygon shapefile is 
          located. Select the
    ...
    { // STEP 4
      title: (
        <>
          The selected shapefile displays in the <strong>Bounding Polygon Shapefile</strong> dropdown menu (<FigReference figKey="figure-153" />). Enter
          ...
          displayed in the <em>Import Road Network From OpenStreetMap</em> dialog box (<FigReference figKey="figure-153" />) is relative to the
    ...
    { // STEP 5
      title: (
        <>
          ...
          the <em>Import Road Network From OpenStreetMap</em> dialog box (<FigReference figKey="figure-153" />) is relative to the horizontal unit of
    ...
    { // STEP 6
      title: (
        <>
          The <strong>OSM Highway and CFCC</strong> table (<FigReference figKey="figure-153" />) allows users to select road -- classified by CFCC codes -- to 
    ...
    { // STEP 7
      title: (
        <>
          Click <strong>OK</strong>, and the <em>Import Road Network From OpenStreetMap</em> dialog box (<FigReference figKey="figure-153" />)
          closes and a <em>Progress Window</em> opens (<FigReference figKey="figure-154" />). The <em>Progress Window</em> displays the import
    ...
    { // STEP 8
      title: (
        <>
          Once the import is completed, the <em>Progress Window</em> (<FigReference figKey="figure-154" />) closes. From the LifeSim
...
menu (<FigReference figKey="figure-155" />). Another way is from the LifeSim main window, from the <strong>Study</strong> menu, point to <strong>Road
Network Data</strong> (<FigReference figKey="figure-148" />), point to <strong>Edit</strong>, and click a road network dataset.

Either way, the *Edit Road Network* dialog box (<FigReference figKey="figure-156" />) opens. Section [Import from a
...
From the shortcut menu (<FigReference figKey="figure-155" />), click <strong>Show In Map Window</strong>. The selected road network dataset displays in the map window
...
B](./18-appendix-map-preferences.mdx) for details on modifying road networks using dangles). From the LifeSim main window, from 
the **Study** tab, from the *Study Tree*, from the **Road Networks** folder, right-click on a road network
dataset. From the shortcut menu (<FigReference figKey="figure-155" />), click **Show Dangles in Map Window**. The selected road network dataset's dangles
...
right-click on a road network dataset. From the shortcut menu (<FigReference figKey="figure-155" />), click <strong>Copy</strong>. 

Another way is from the LifeSim main window, from the <strong>Study</strong> menu, point to <strong>Road Network Data</strong> (<FigReference figKey="figure-148" />),
...
network dataset. From the shortcut menu (<FigReference figKey="figure-155" />), click <strong>Delete</strong>. 

Another way is from the LifeSim main window, from the <strong>Study</strong> menu, point to <strong>Road Network Data</strong> (<FigReference figKey="figure-148" />), 
point to <strong>Delete</strong>, and click a road network dataset.

Either way, a *Confirm Delete* window (similar to <FigReference figKey="figure-115" />) opens asking for confirmation to delete the
