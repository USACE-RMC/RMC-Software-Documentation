...
<ProcessList
  items={[
    ...
    { // STEP 4
      title: (
        <>
          ...
          the <strong>Bounding Polygon Buffer</strong> distance (positive value) if the default value of <strong>0</strong> is not desired. Note: the units
    ...
    { // STEP 5
      title: (
        <>
          Enter the <strong>Maximum Road Length</strong> if the default value of <strong>3000</strong> is not desired. Note: the units displayed in
