...
The <Link to="/docs/desktop-applications/lifesim/technical-reference-manual/v1.0/road-networks-destinations-and-evacuation-parameters">LifeSim Technical Reference Manual: Road Networks, Destinations, and Evacuation Parameters</Link> describes 
