    ...
    { // STEP 2
      title: (
        <>
          ...
          Editor</em> (<FigReference figKey="figure-127" />). Review <Link to="/docs/desktop-applications/lifesim/users-guide/v1.0/lifesim-interface#customizing-plots-and-plotting-tools">Customizing
