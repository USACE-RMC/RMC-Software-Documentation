...
is not limited to breach flood hazards (HEC 2018). The key component of LifeSim’s methodology is that the magnitude of life loss depends on whether
people evacuate successfully and whether those who fail to evacuate can find adequate shelter (Aboelata, Bowles, and McClelland 2003).
