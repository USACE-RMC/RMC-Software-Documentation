...
The LifeSim software is developed at RMC, which is a division of the Institute for Water Resources (IWR), USACE. The first version of LifeSim (Version 1.0) was 
...
and Chris Dunn was the director during the development of this version of the
software.
...
information can be found in the <Link to="/docs/desktop-applications/lifesim/users-guide/v1.0/welcome-to-lifesim">LifeSim User's Guide</Link>.  All manuals 
