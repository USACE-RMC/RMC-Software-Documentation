...
For example, <FigureReference figKey="risk-analysis-process"/> illustrates the conceptual risk analysis process for a levee with a single failure mode and a
...
src="figures/desktop-applications/rmc-totalrisk/users-guide/figure0.png"
...
analysis, refer to the technical reference manual <Citation citationKey="TechRef" bibFile="/bibliographies/rmc-totalrisk-users-guide-bib.json"/>. Additional USACE guidance on risk
analysis for flood risk management is in <Citation citationKey="EM1619" bibFile="/bibliographies/rmc-totalrisk-users-guide-bib.json"/>
and <Citation citationKey="BestPractices" bibFile="/bibliographies/rmc-totalrisk-users-guide-bib.json"/>.
