...
To create a tabular consequence function, right-click on the **Consequences** folder in the Project Explorer (<FigReference figKey="create-tabular-consequence" />) or
...
<Figure  
figKey="create-tabular-consequence"  
...
(<FigReference figKey="tabular-consequence-properties" />). In the Properties window, you can set the name, description, hazard type, hazard units, consequence, consequence
...
<Figure  
figKey="tabular-consequence-properties"  
...
(<FigReference figKey="tabular-consequence-example" />). Define uncertainty around the consequence for each tabular ordinate. Select a distribution to define uncertainty and
...
<Figure  
figKey="tabular-consequence-example"  
...
When you enter invalid data, the table cell turns red and a tooltip indicates the source of the error, as shown in <FigReference figKey="tabular-consequence-validation" />.
In addition, an error message appears in the Message window, prompting you to resolve all errors in the data table.

<Figure  
figKey="tabular-consequence-validation"  
...
To create a composite consequence function, right-click on the **Consequences** folder in the Project Explorer (<FigReference figKey="create-composite-consequence" />) or go
...
<Figure  
figKey="create-composite-consequence"  
...
(<FigReference figKey="composite-consequence-properties" />). In the Properties window, you can set the name, description, hazard type, hazard units, consequence, consequence
unit, hazard and consequence interpolation transforms, composite type, and input consequence functions.

<Figure  
figKey="composite-consequence-properties"  
