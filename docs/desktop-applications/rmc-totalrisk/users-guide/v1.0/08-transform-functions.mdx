...
To create a linear transform function, right-click on the **Transforms** folder in the Project Explorer (<FigReference figKey="figure-74" />)
...
(<FigReference figKey="figure-75" />). In the Properties window, you can set the name, description, hazard type, hazard units, transformed
...
The Tabbed Document for a linear transform function includes a graphical representation of the function (<FigReference figKey="figure-76" />).
...
To create a power transform function, right-click on the **Transforms** folder in the Project Explorer (<FigReference figKey="figure-77" />)
...
(<FigReference figKey="figure-78" />). In the Properties window, you can set the name, description, hazard type, hazard units, transformed
...
The Tabbed Document for a power transform function contains a graphical representation of the function (<FigReference figKey="figure-79" />).
...
To create a tabular transform function, right-click on the **Transforms** folder in the Project Explorer (<FigReference figKey="figure-80" />)
...
(<FigReference figKey="figure-81" />). In the Properties window, you can specify the name, description, hazard type, hazard units,
...
The Tabbed Document for a tabular function includes a table for entering data and a graphical representation of that data (<FigReference figKey="figure-82" />).
...
When you enter invalid data, the table cell turns red, and a tooltip explains the error, as shown in <FigReference figKey="figure-83" />.
