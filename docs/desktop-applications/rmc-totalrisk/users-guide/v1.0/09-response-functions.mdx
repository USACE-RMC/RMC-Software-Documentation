...
(<FigReference figKey="parametric-response-properties" />). In the Properties window, you can set the name, description, hazard type, and hazard units. Define the parametric
...
<Figure  
figKey="parametric-response-properties"  
...
To create a tabular response function, right-click on the **System Responses folder** in the Project Explorer (<FigReference figKey="create-tabular-response" />) or go to
...
<Figure
figKey="create-tabular-response"
...
function's properties (<FigReference figKey="tabular-response-properties" />). In the Properties window, you can configure the name, description, hazard type, hazard units,
...
<Figure
figKey="tabular-response-properties"
...
The Tabbed Document for a tabular response function includes a table for data entry and a graphical representation of the data (<FigReference figKey="tabular-response-example" />).
...
<Figure
figKey="tabular-response-example"
...
If you enter invalid data, the corresponding table cell turns red, and a tooltip explains the error, as shown in <FigReference figKey="tabular-response-validation" />.
In addition, an error message appears in the Message window prompting you to resolve all errors in the data table.

<Figure
figKey="tabular-response-validation"
...
To create a composite response function, right-click on the **System Responses** folder in the Project Explorer (<FigReference figKey="create-composite-response" />)
...
<Figure
figKey="create-composite-response"
...
(<FigReference figKey="composite-response-properties" />). In the Properties window, you can configure the name, description, hazard type, hazard units, and input response
...
<Figure
figKey="composite-response-properties"
