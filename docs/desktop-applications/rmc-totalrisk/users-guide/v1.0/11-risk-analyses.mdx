...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure123.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure124.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure125.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure126.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure127.png"
...
For more details on the numerical integration methods used by RMC-TotalRisk, refer to the technical reference manual <Citation key="cite-TechRef" />.
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure128.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure129.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure130.png"
...
<Figure
  figKey="risk-diagram"
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure131.png"
...
The risk diagram connects input functions from left to right, linking them based on their hazard type (e.g., stage, flow) and units (e.g., ft, cfs). Circular or redundant
connections are not allowed, making the risk diagram a type of directed acyclic graph (DAG).

System components in the diagram are labeled by their selected hazard functions. You can rename system components by right-clicking their names in the diagram or editing
their names in the Properties window. Failure modes within each component are labeled by their corresponding response functions.
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure132.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure133.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure134.png"
...
- <FigureInline src="/figures/desktop-applications/rmc-totalrisk/users-guide/hazardIcon.png"/> **Hazard Node**: Describes exceedance probabilities for various hazard levels 
...
- <FigureInline src="/figures/desktop-applications/rmc-totalrisk/users-guide/transformIcon.png"/> **Transform Node**: Converts hazard levels from one type to another 
(e.g., flow 
to stage). Transform nodes can connect sequentially and have multiple outputs unless linked to a response function.

- <FigureInline src="/figures/desktop-applications/rmc-totalrisk/users-guide/responseIcon.png"/> **Response Node**: Represents the system’s conditional probability of 
failure at 
various hazard levels. Response nodes define failure modes and allow one output connection.

- <FigureInline src="/figures/desktop-applications/rmc-totalrisk/users-guide/consequenceIcon.png"/> **Consequence Node**: Defines the consequences of failure or non-failure. 
...
- <FigureInline src="/figures/desktop-applications/rmc-totalrisk/users-guide/noInputSelected.png"/> **No Input Selected**: Red outlines indicate a node with no input defined.

- <FigureInline src="/figures/desktop-applications/rmc-totalrisk/users-guide/incompleteConnection.png"/> **Incomplete Connection**: Black lines indicate valid connections 
that lack complete failure or non-failure modes.

- <FigureInline src="/figures/desktop-applications/rmc-totalrisk/users-guide/invalidConnection.png"/> **Invalid Connection**: Red lines indicate mismatched units or 
undefined inputs.

- <FigureInline src="/figures/desktop-applications/rmc-totalrisk/users-guide/validNFModeConnection.png"/> **Valid Non-Failure Mode Connection**: Purple lines indicate 
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/figure135.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/riskproperties.png"
...
<Figure
  ...
  src="figures/desktop-applications/rmc-totalrisk/users-guide/risksimulation.png"
  alt="Decorative."
