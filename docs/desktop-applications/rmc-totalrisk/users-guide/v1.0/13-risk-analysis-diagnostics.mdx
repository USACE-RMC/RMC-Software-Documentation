...
<FigReference figKey="levee-risk-diagram-assurance" /> illustrates an example risk diagram for a levee risk analysis. The primary hazard is river peak flow frequency, which 
...
<Figure  
figKey="levee-risk-diagram-assurance"  
