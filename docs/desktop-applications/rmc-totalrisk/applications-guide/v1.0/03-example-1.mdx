...
headers={
  [
    [
      { value: 'Stage (ft)' },
      { value: '5th Percentile AEP' },
      { value: '50th Percentile AEP' },
      { value: '95th Percentile AEP' }
    ]
]
}
columns={[
...
src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figure1.png" 
fullWidth={true}
...
src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figure2.png" 
fullWidth={true}
...
<ProcessList
  ...
  the Project Explorer window and select <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/addeventtree.png"/>
   ...
   hazard level table.
        ...
        <Figure 
          ...
          src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figure3.png" 
          fullWidth={true}
  ...
  <ol style={{ listStyleType: 'lower-alpha' }}>
    <li>Click the <strong>Add new branch</strong> <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/newbranch.png"/> button (to add a
      ...
      button (to delete branches) in the node toolbar, <FigReference  figKey="example-1-bep-branch-props"/>(a).</li>

    <li>Click the <strong>Add Branch Node</strong> <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/newbranch.png"/> button (to add a
      ...
      delete branches) in the <strong>Sub-Branches</strong> section of the Properties window, <FigReference  figKey="example-1-bep-branch-props"/>(b).</li>
  </ol>
        </> )
    }, 
    { //Step 6
...
<Figure 
    ...
    src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figure4.png" 
    fullWidth={true}
   ...
   reasonable value (LRV), most likely value (MLV), and a maximum or highest reasonable value (HRV). The <strong>Source</strong> for Node 1 is set to <em>Single Value</em>&nbsp; 
    and the <strong>Distribution</strong> is set to <em>Triangular</em>.
        ...
        <Figure 
          ...
          src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figure5.png" 
          fullWidth={true}
   ...
   of the event tree using the same procedure.
        ...
        <Figure 
          ...
          src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figure6.png" 
   ...
   window, <FigReference figKey="example-1-bep-srp-plot" />(d), along with other axis customizations.
        ...
        <Figure 
            ...
            src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figure7.png" 
            fullWidth={true}
...
To create an economic cost consequence function, the procedure is the same as documented in <a href="/RMC-Software-Documentation/docs/desktop-applications/rmc-totalrisk/applications-guide/v1.0/example-1#life-loss-function" target="_blank" rel="noopener noreferrer">Life Loss Function</a>. In step 2 and step 7, 
...
<ProcessList
    ...
    { //Step 1
      ...
      title: (
      <>
     Right-click the <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/folder.png"/> **Risk Analyses** folder and select <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/addriskanalysis.png"/> **Add Risk Analysis…** Name the risk analysis in the prompt (e.g., Backward Erosion Piping 
     with Intervention) and press **OK**.
      </> )
    },
    { //Step 2
      ...
      title: (
      <>
     For **Consequence** and **Consequence Unit** in the **Risk Analysis Properties** section of the Properties window, select _Life Loss and Lives_, <FigReference figKey="example-1-risk-analysis-diagram" />(a).
      </> )
    },
    { //Step 3
      ...
      title: (
        ...
        components to the risk analysis **Diagram** by clicking the <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/newbranch.png"/> green plus sign, clicking on a node output connector, or right-clicking anywhere in the diagram.

  <ol style={{ listStyleType: 'lower-alpha' }}>
    <li>First, add a hazard node <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/hazardicon.png"/> 
    to the diagram. Select the hazard function (e.g., Stage Frequency) from the blank drop-down box in the hazard node.</li>
    <li>Next, add the non-breach condition by clicking on the hazard node output connector and adding a 
    ...
    the composite non-breach life loss function (e.g., Non-Breach) from the drop-down box. </li>
    <li> Finally, add the backward erosion piping potential failure mode and the associated breach condition.
      <ol>
        <li>Add a response node <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/responseIcon.png"/>  by clicking on the hazard node output connector and select the appropriate system response function 
        (e.g., Backward Erosion Piping with Intervention) from the drop-down box.</li>
        <li>Add the breach condition by clicking on the response node output connector and adding a consequence node <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/consequenceIcon.png"/>
        and selecting the composite breach life loss function (e.g., Internal Erosion) from the drop-down box.</li>
      </ol>
    </li>
    <li>Re-arrange the nodes (click and hold, then drag) as desired to personalize the diagram.</li>
  </ol>
        </> )
    },
    { //Step 4
      ...
      title: (
      <>
     When running a risk analysis with uncertainty, the simulation options can be adjusted within the **Options** tab of the Properties window.

     <ol style={{ listStyleType: 'lower-alpha' }}>
      <li>Within the **Simulation Options** section, the **Confidence Interval** is set to _90%_ and **Realizations** is set to _10,000_, <FigReference figKey="example-1-risk-analysis-sim-ops" />(a).</li>
      <li>The **Integration Option**s, **System Component Option**s, **System Option**s, and **Risk Measure Option**s are set to their default values, <FigReference figKey="example-1-risk-analysis-sim-ops" />(b).</li>
     </ol>
      </> )
    },
		{ //Step 5
			...
			title: (
      <>
      5.	To run the risk analysis without uncertainty, select _Simulate Mean Risk Only_ in the **Simulation** section of the Properties window and 
      click <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/estimate.png"/> **Estimate**, Figure 12(c). To run the risk analysis with uncertainty, select _Simulate Risk with Full Uncertainty_. 
      </> ),
      ...
      <Figure 
            ...
            src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figure12.png" 
            fullWidth={true}
      ...
      src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figure13.png" 
      fullWidth={true}
