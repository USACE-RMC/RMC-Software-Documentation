...
<ProcessList
	items={[
     ...
     <Figure 
        ...
        figKey="example-2-bep-no-intervene-n6"
...
Reference the procedure in [Consequences](./03-example-1.mdx#consequences) 
from Example 1 to create the consequence functions for this risk analysis.
...
_Exceedance Probability_, α (also referred to as annual probability of failure, APF) of 3.71E-05 without intervention and 6.89E-06 with intervention. 
...
<Figure 
    docId="04-example-2.mdx"
    figKey="example-2-risk-analysis-summary"
...
<Figure 
    docId="04-example-2.mdx"
    figKey="example-2-inc-fn-uncertain"
...
<Figure 
    docId="04-example-2.mdx"
    figKey="example-2-an-uncertain-scatter"
