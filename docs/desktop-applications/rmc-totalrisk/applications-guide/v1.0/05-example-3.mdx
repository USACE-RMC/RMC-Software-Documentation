...
This example starts with the completed risk analysis from [Example 1](./03-example-1.mdx)  and adds three additional PFMs: overtopping erosion (OT), 
...
<ProcessList
	items={[
      ...
      the Project Explorer window and select <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/addtabtransform.png"/> Add <strong>Tabular Transform…</strong> Name the transform function in the
    ...
    { //Step 2
     ...
     The stage frequency hazard is stage and is measured in feet. The hazard for the concrete lined spillway erosion is spillway discharge and is measured
      in cubic feet per second (cfs). In the <strong>Tabular Transform Properties</strong> section of the Properties window, <FigReference figKey="example-3-stage-spillway-discharge"/>(a), select <em>Stage</em> for <strong>Hazard Type</strong>, <em>ft</em> for <strong>Hazard Units</strong>, 
      <em>Flow</em> for <strong>Transformed Hazard</strong>, and <em>cfs</em> for <strong>Transformed Units</strong>.
      </> )
    },
    { //Step 3
    ...
    { //Step 4
     ...
     data from <TableReference tableKey="example-3-stage-spillway-discharge"/> into the table, <FigReference figKey="example-3-stage-spillway-discharge"/>(d).
      ...
      freeform: ( <> 
        ...
        figKey="example-3-stage-spillway-discharge"
        ...
        <TableVertical
          tableKey="example-3-stage-spillway-discharge"
          ...
          columns={[
            [
              "640.06", "640.60", "641.14", "641.68", "642.23", "643.31", "643.85", "643.92", "643.98", "644.04",
              "644.10", "644.16", "644.22", "644.35", "644.41", "644.47", "644.53", "644.60", "644.66", "644.72",
              "644.78", "644.84", "644.90", "644.97", "645.10", "645.12", "645.15", "645.17", "645.22", "645.24", 
              "645.27", "645.30", "645.32", "645.35", "645.37"

            ],
            [
              "1,976", "4,512", "6,214", "7,147", "7,793", "8,104", "8,568", "9,139", "9,726", "10,439", 
              "12,543", "16,055", "22,158", "28,177", "30,881", "33,986", "38,701", "46,070", "58,272", 
              "76,183", "81,064", "83,861", "86,659", "89,456", "98,296", "99,952", "101,608", "102,013", 
              "102,630", "102,939", "103,247", "103,607", "103,650", "103,694", "103,738"

            ],
            [
              "645.39", "645.42", "645.44", "645.47", "645.51", "645.54", "645.56", "645.59", "645.61", "645.64", 
              "645.66", "645.68", "645.71", "645.73", "645.76", "645.80", "646.35", "646.91", "647.46", "648.01", 
              "648.57", "649.12", "649.67", "650.23", "650.78", "651.33", "651.89", "652.44", "652.99", "653.55", 
              "654.10", "654.67", "655.25", "655.82", "656.39"

            ],
            [
              "103,781", "103,825", "103,868", "103,912", "103,999", "104,043", "104,086", "104,130", "104,173", "104,217", 
              "104,260", "104,304", "104,348", "104,391", "104,435", "104,515", "105,513", "106,473", "107,421", "108,368", 
              "109,316", "110,264", "111,211", "112,157", "113,081", "113,983", "114,885", "115,785", "116,666", "117,526", 
              "118,385", "119,275", "120,152", "121,027", "121,901"
      ...
      Copy and paste the spillway discharge and stage data into the appropriate column of the table, Figure 24. <em>Flow</em> will be in the <strong>X</strong> column and <em>Stage</em> will be in the <strong>Value</strong> column.
      </> ),
      
      freeform: ( <> 
      <Figure 
        docId="05-example-3.mdx"
        figKey="example-3-spillway-discharge-stage"
        src="figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/figures/figure24.png" 
        fullWidth={true}
        alt="Spillway discharge to stage transform function." 
...
<TableVertical 
tableKey="example-3-overtop-erosion-prob"
...
columns={[
  ...
  [ // 650.15
    "0.003", "0.075", "0.225", "0.101",
    "0.001", "0.008", "0.060", "0.023",
    "0.050", "0.350", "0.600", "0.333",
  ...
  [ // 651.15
    "0.500", "0.775", "0.900", "0.725",
    "0.450", "0.680", "0.900", "0.677",
    "0.055", "0.500", "0.850", "0.468",
    "0.050", "0.100", "0.580", "0.243",
    "0.020", "0.300", "0.500", "0.273",
    "1.53E-02",
    "2.11E-02"
  ],
  [ // 652.15
    "0.850", "0.945", "0.999", "0.931",
    "0.750", "0.900", "0.999", "0.883",
    "0.500", "0.750", "0.900", "0.717",
    "0.450", "0.780", "0.990", "0.740",
    "0.500", "0.680", "0.900", "0.693",
    "3.02E-01",
    "3.25E-01"
  ],
  [ // 654.15
    "0.945", "0.995", "0.999", "0.980",
    "0.850", "0.900", "0.999", "0.916",
    "0.750", "0.900", "0.990", "0.880",
    "0.900", "0.990", "0.999", "0.963",
    "0.580", "0.750", "0.950", "0.760",
    "5.78E-01",
    "5.90E-01"
  ],
  [ // 656.60
    "0.995", "0.999", "0.999", "0.998",
    "0.990", "0.999", "0.999", "0.996",
    "0.995", "0.999", "0.999", "0.998",
    "0.990", "0.999", "0.999", "0.996",
    "0.700", "0.900", "0.990", "0.863",
    "8.52E-01",
    "8.54E-01"
  ]
]}
...
<Figure 
  docId="05-example-3.mdx"
  figKey="example-3-overtop-erosion-tree"
...
<Figure 
  docId="05-example-3.mdx"
  figKey="example-3-overtop-erosion-properties"
...
<TableVertical 
  ...
  columns={[
    ...
    [ // 641.00
      "0.040", "0.150", "0.450", "0.213", 
      "0.100", "0.450", "0.750", "0.433", 
      "0.800", "0.895", "0.999", "0.898", 
      "0.075", "0.225", "0.500", "0.267", 
      "0.003", "0.008", "0.075", "0.029", 
      "0.068", "0.162", "0.681", "0.304", 
      "0.008", "0.045", "0.200", "0.084", 
    ...
    [ // 642.50
      "0.040", "0.150", "0.450", "0.213", 
      "0.100", "0.450", "0.750", "0.433", 
      "0.825", "0.945", "0.999", "0.923", 
      "0.100", "0.238", "0.500", "0.279", 
      "0.003", "0.008", "0.075", "0.029", 
      "0.068", "0.162", "0.681", "0.304", 
      "0.018", "0.050", "0.250", "0.106", 
    ...
    [ // 644.00
      ...
      "0.100", "0.450", "0.750", "0.433", 
      "0.825", "0.945", "0.999", "0.923", 
      "0.125", "0.275", "0.563", "0.321", 
      "0.003", "0.008", "0.075", "0.029", 
      "0.068", "0.162", "0.681", "0.304", 
      "0.025", "0.075", "0.250", "0.117", 
      "0.003", "0.010", "0.035", "0.016",
      "4.45E-07",
      "3.81E-06"
    ],
    [ // 645.50
      ...
      "0.100", "0.450", "0.750", "0.433", 
      "0.825", "0.945", "0.999", "0.923", 
      "0.138", "0.313", "0.625", "0.359", 
      "0.003", "0.008", "0.075", "0.029", 
      "0.068", "0.162", "0.681", "0.304", 
      "0.050", "0.100", "0.300", "0.150", 
      "0.006", "0.025", "0.075", "0.035",
      "1.41E-06",
      "9.41E-06"
    ],
    [ // 647.50
      "0.040", "0.150", "0.450", "0.213", 
      "0.100", "0.450", "0.750", "0.433", 
      "0.850", "0.960", "0.999", "0.936", 
      "0.150", "0.400", "0.700", "0.417", 
      "0.003", "0.008", "0.075", "0.029", 
      "0.068", "0.162", "0.681", "0.304", 
      "0.100", "0.250", "0.500", "0.283", 
      "0.020", "0.080", "0.250", "0.117",
      "1.04E-05",
      "3.66E-05"
    ],
    [ // 649.65
      "0.040", "0.150", "0.450", "0.213", 
      "0.100", "0.450", "0.750", "0.433", 
      "0.875", "0.970", "0.999", "0.948", 
      "0.213", "0.450", "0.775", "0.479", 
      "0.003", "0.008", "0.075", "0.029", 
      "0.068", "0.162", "0.681", "0.304", 
      "0.845", "0.900", "0.999", "0.915", 
      "0.100", "0.250", "0.825", "0.392",
      "1.31E-04",
      "1.43E-04"
    ]
  ]}
...
<Figure 
  docId="05-example-3.mdx"
  figKey="example-3-internal-migration-tree"
...
<Figure 
  docId="05-example-3.mdx"
  figKey="example-3-internal-migration-properties"
...
<Figure 
  docId="05-example-3.mdx"
  figKey="example-3-internal-migration-intervene"
...
<Figure 
  docId="05-example-3.mdx"
  figKey="example-3-internal-migration-wo-intervene"
...
<TableVertical 
  tableKey="example-3-concrete-erosion-prob"
  headerAlign={["center", "center", "center", "center", "center", "center", "center", "center"]}
  headers={[
    [
    { value: "Spillway Discharge (cfs)", colSpan: 2, rowSpan: 1 },
    { value: "25,000", colSpan: 1, rowSpan: 1 },
    { value: "40,000", colSpan: 1, rowSpan: 1 },
    { value: "90,000", colSpan: 1, rowSpan: 1 },
    { value: "180,000", colSpan: 1, rowSpan: 1 },
    { value: "235,000", colSpan: 1, rowSpan: 1 },
  ]
  ]}
  columns={[
    [ // First column 
    ...
    [ // 25,000
      ...
      "0.001","0.001","0.006","0.003",
      "0.900","0.950","0.990","0.947",
      "0.900","0.950","0.990","0.947",
      "0.100","0.250","0.600","0.317",
      "0.100","0.250","0.600","0.317",
      "0.050","0.100","0.400","0.183",
      "0.050","0.100","0.400","0.183",
    ...
    [ // 40,000
      "0.000","0.000","0.001","0.000",
      "0.006","0.030","0.150","0.062",
      "0.000","0.000","0.000","0.000",
      "0.001","0.005","0.010","0.005",
      "0.001","0.005","0.010","0.005",
      "0.003","0.030","0.100","0.044",
      "0.003","0.030","0.100","0.044",
      "0.990","0.990","0.999","0.993",
      "0.990","0.990","0.999","0.993",
      "0.250","0.500","0.850","0.533",
      "0.250","0.500","0.850","0.533",
      "0.080","0.150","0.450","0.227",
      "0.080","0.150","0.450","0.227",
      "0.025","0.075","0.150","0.083",
      "0.025","0.075","0.150","0.083",
      "4.89E-11",
      "1.10E-09"
    ],
    [ // 90,000
      ...
      "0.035","0.100","0.275","0.137",
      "0.000","0.001","0.003","0.001",
      "0.004","0.075","0.182","0.087",
      "0.004","0.075","0.182","0.087",
      "0.150","0.500","0.825","0.492",
      "0.150","0.500","0.825","0.492",
      "0.999","0.999","0.999","0.999",
      "0.999","0.999","0.999","0.999",
      "0.400","0.750","0.900","0.683",
      "0.400","0.750","0.900","0.683",
      "0.090","0.200","0.550","0.280",
      "0.090","0.200","0.550","0.280",
      "0.050","0.090","0.250","0.130",
      "0.050","0.090","0.250","0.130",
      "1.66E-06",
      "3.37E-06"
    ],
    [ // 180,000
      "0.010","0.075","0.175","0.087",
      "0.250","0.600","0.800","0.550",
      "0.006","0.035","0.200","0.080",
      "0.100","0.350","0.696","0.382",
      "0.100","0.350","0.696","0.382",
      "0.775","0.925","0.995","0.898",
      "0.775","0.925","0.995","0.898",
      "0.999","0.999","0.999","0.999",
      "0.999","0.999","0.999","0.999",
      "0.650","0.900","0.990","0.847",
      "0.650","0.900","0.990","0.847",
      "0.100","0.450","0.750","0.433",
      "0.100","0.450","0.750","0.433",
      "0.080","0.100","0.400","0.193",
      "0.080","0.100","0.400","0.193",
      "2.94E-03",
      "3.28E-03"
    ],
    [ // 235,000
      "0.100","0.600","0.825","0.508",
      "0.550","0.800","0.945","0.765",
      "0.010","0.075","0.325","0.137",
      "0.325","0.688","0.878","0.630",
      "0.325","0.688","0.878","0.630",
      "0.900","0.970","0.999","0.956",
      "0.900","0.970","0.999","0.956",
      "0.999","0.999","0.999","0.999",
      "0.999","0.999","0.999","0.999",
      "0.800","0.900","0.990","0.897",
      "0.800","0.900","0.990","0.897",
      "0.250","0.700","0.900","0.617",
      "0.250","0.700","0.900","0.617",
      "0.090","0.150","0.500","0.247",
      "0.090","0.150","0.500","0.247",
      "3.75E-02",
      "3.92E-02"
    ]
...
<Figure 
  docId="05-example-3.mdx"
  figKey="example-3-concrete-erosion-tree"
...
<Figure 
  docId="05-example-3.mdx"
  figKey="example-3-concrete-erosion-properties"
...
<TableVertical
  ...
  columns={[
    ...
    [
      "Flood", "Backward Erosion</br>Piping", "Stage", "ft", "None (linear)", "Logarithmic", "6 <br/>(See Table 3 & Figure 3)", "See Table 3"

    ],
    [
      "Flood", "Embankment Overtopping</br>Erosion", "Stage", "ft", "None (linear)", "None (linear)", "6 <br/>(See Table 7 & Figure 26)", "See Table 7"

    ],
    [
      "Flood", "Internal Migration of</br>Embankment into</br>the Foundation", "Stage", "ft", "None (linear)", "Logarithmic", "6 <br/>(See Table 8 & Figure 30)", "See Table 8"
    ],
    [
      "Flood", "Concrete Lined</br>Spillway Erosion", "Flow", "cfs", "None (linear)", "Logarithmic", "5 <br/>(See Table 9 & Figure 34)", "See Table 9"
    ]
  ]}
  widthMode="intrinsic"
  />
...
For this example, daytime and nighttime life loss estimates were developed for a range of reservoir stages for non-breach (<TableReference tableKey="example-1-non-breach-life-loss"/>) and the following breach scenarios: 
...
<TableVertical 
  tableKey="example-3-overtop-breach-loss"
...
<TableVertical 
  tableKey="example-3-concrete-erosion-breach-loss"
  headerAlign={["center", "center", "center", "center", "center", "center", "center", "center", "center"]}
  headers={[
    [
    { value: "Stage (ft)", colSpan: 1, rowSpan: 2 },
...
columns={[
  ...
  [
    "Stage", "ft", "None (linear)", "None (linear)", "PERT", "See Table 5", "Mixture"

  ],
  [
    "Stage", "ft", "None (linear)", "None (linear)", "PERT", "See Table 11", "Mixture"
  ...
  [
    "Stage", "ft", "None (linear)", "None (linear)", "PERT", "See Table 12", "Mixture"
  ]
]}
widthMode="intrinsic"
/>
...
<ProcessList
    ...
    { //Step 4
      ...
      freeform: ( <> 
        <Figure 
          docId="05-example-3.mdx"
          figKey="example-3-tot-proj-intervene"
      ...
      title: (
        <>
      Within the <strong>System Component Option</strong>s section, set the <strong>Failure Mode Method</strong> to <em>Joint Failures</em> and set the <strong>Joint Consequences</strong> to <em>Maximum</em>, <FigReference figKey="example-3-tot-risk-intervene-ops" />(a).
         Additional options for Failure Mode Method include <em>Common Cause Failures</em> and <em>Competing Failures</em> (the <strong>Joint Consequences</strong> option will not be displayed if either 
         <strong>Common Cause Failures</strong> or <strong>Competing Failures</strong> is selected).
      </>
      )
        },
      ...
      title: (
      <>
      Within the <strong>Simulation Option</strong>s section, set the <strong>Confidence Interval</strong> to <em>90%</em> and set 
      the <strong>Realization</strong>s to <em>10,000</em>, <FigReference figKey="example-3-tot-risk-intervene-ops" />(b). 
      </>
      )
      },
      ...
      title: (
      <>
      The <strong>Integration Option</strong>s, <FigReference figKey="example-3-tot-risk-intervene-ops" />(c), <strong>System Option</strong>s, 
      <FigReference figKey="example-3-tot-risk-intervene-ops" />(d), 
      and <strong>Risk Measure Option</strong>s, <FigReference figKey="example-3-tot-risk-intervene-ops" />(e), are set to their default values. 
      </> 
      )
      }
      ],
      ...
      <Figure 
        docId="05-example-3.mdx"
        figKey="example-3-tot-risk-intervene-ops"
    ...
    { //Step 6
      ...
      <>
        To run the risk analysis without uncertainty, select <em>Simulate Mean Risk Only</em> in the <strong>Simulation</strong> section of the Properties window and click
         ...
         To run the risk analysis with uncertainty, select <em>Simulate Risk with Full Uncertainty</em> and click <FigureInline src="/figures/desktop-applications/rmc-totalrisk/applications-guide/v1.0/icons/chancenode.png"/> <strong>Estimate</strong>. 
      </> )
    },
    { //Step 
...
shown in <FigReference figKey="example-3-sum-stats-tot-risk" />. This table shows the incremental Mean, E[N] (also referred to as the average annual life loss, AALL), of 
1.02E-02 without intervention and 4.75E-03 with intervention and an Exceedance Probability, α (also referred to as annual 
probability of failure, APF) of 9.63E-05 without intervention and 6.34E-05 with intervention. 

<Figure 
  docId="05-example-3.mdx"
  figKey="example-3-sum-stats-tot-risk"
