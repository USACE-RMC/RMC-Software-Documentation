...
<FigureNoRef 
    src="/figures/toolbox-technical-manuals/risk-calculations-suite/typical-event-tree-database/v1.0/Embankment-Riverine-Erosion.png" 
    alt="Embankment Riverine Erosion event tree" />
