...
<FigureNoRef 
    src="/figures/toolbox-technical-manuals/risk-calculations-suite/typical-event-tree-database/v1.4/Embankment-Overtopping-Erosion.png" 
    alt="Embankment Overtopping Erosion event tree" />

:::info NOTE
Do not consider temporary crest raises.
:::
