...
resistance (N or blow count) for cohesionless soils and rock and SPT blow count and undrained shear strength for cohesive soils. <TableReference tableKey="table-1" /> outlines the
    ...
    [
      ...
      },
      {
        value: (
          <>
            {' '}
            <EquationNoRef equation="\overline{s_u}" /> (psf)
          </>
        ),
        rowSpan: 1,
        colSpan: 1,
...
<Equation
  ...
  equation="\overline{N} = \frac{\displaystyle\sum_{\displaystyle i=1}^{n} d_i}{\displaystyle\sum_{\displaystyle i=1}^{n} \frac{d_i}{N_i}}"
/>
