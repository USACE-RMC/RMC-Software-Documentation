...
:::
<Citation citationKey="Wan2008" /> determined that the methods of Kenney and Lau (1985, 1986) or <Citation citationKey="Sherard1979" /> were too
...
graded silt-sand-gravel soils using the ratios of <em>D</em><sub>90</sub><em>D</em><sub>60</sub> and <em>D</em><sub>20</sub><em>D</em><sub>5</sub>,
where <em>D</em><sub>90</sub>, <em>D</em><sub>60</sub>, <em>D</em><sub>20</sub>, and <em>D</em><sub>5</sub> are the particle sizes corresponding to
90, 60, 20, and 5 percent finer by weight on the cumulative particle-size distribution curve, respectively.

<Citation citationKey="Wan2008" /> identified two boundaries related to internal instability, as illustrated in <FigReference figKey="figure-28" />.
...
Insert `<EquationNoRef />` component(s) to render math in the following paragraph.
:::
This worksheet assesses the susceptibility of broadly graded silt-sand-gravel soils to internal instability using the
...
less than 20 percent may not be adequately assessed by this method. While it has not been proven by tests, <Citation citationKey="Wan2008" />
indicated if the slope of the finer fraction is used in lieu of the <em>D<sub>2</sub></em><sub>0</sub><em>D<sub>5</sub></em> ratio, the method should
be applicable.
