...
are the particle sizes corresponding to 90, 60, 20, and 5 percent finer by weight on the cumulative particle-size distribution curve, respectively.
...
<Figure
  ...
  caption={
    <>
      Alternative method for assessing internal instability of broadly graded silt-sand-gravel soils (adapted Wan and Fell 2008){" "}
      <Citation citationKey="Wan2008" />.
    </>
  }
  width="55%"
/>
