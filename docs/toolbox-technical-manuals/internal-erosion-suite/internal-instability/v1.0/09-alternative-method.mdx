...
<EquationNoRef equation="\displaystyle \frac{30}{log(\frac{D_{90}}{D_{60}})}" /> and
y-axis <EquationNoRef equation="\displaystyle \frac{15}{log(\frac{D_{20}}{D_5})}" /> are user-specified.
