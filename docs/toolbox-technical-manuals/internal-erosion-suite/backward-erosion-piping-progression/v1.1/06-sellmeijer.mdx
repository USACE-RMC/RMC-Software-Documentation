...
al. <Citation citationKey="Sellmeijer2011" bibFile="/bibliographies/108_1_1-bib.json"/>. The adjusted calculation rule extended and updated the piping model
...
piping model testing parameters shown in <TableReference parentDocId="108_1_1" tableKey="sellmeijer-parameter-limits"/>.
...
sand (_θ_), and White’s constant (_η_) as illustrated in <FigReference parentDocId="108_1_1" figKey="sellmeijer-discrete-input"/>. The bedding angle and White’s
...
al. <Citation citationKey="vanBeek2009" bibFile="/bibliographies/108_1_1-bib.json"/> provides guidance for visual estimation of KAS as illustrated
in <FigReference parentDocId="108_1_1" figKey="sellmeijer-KAS-estimate"/>.
...
values. <FigReference parentDocId="108_1_1" figKey="sellmeijer-deterministic-input"/> illustrates the deterministic input.
...
values. <FigReference parentDocId="108_1_1" figKey="sellmeijer-probabilistic-input-no-risk"/> illustrates the probabilistic input without using @RISK.
...
column. <FigReference parentDocId="108_1_1" figKey="sellmeijer-probabilistic-input-risk"/> illustrates the probabilistic input using @RISK.
...
The intrinsic permeability of the fine sand (piping) layer is calculated using <EquationReference parentDocId="108_1_1" equationKey="K-f" />.

<Equation parentDocId="108_1_1" equationKey="K-f" equation="K_{f} = k_{h,f} \frac{μ}{γ_w}" />
...
background. Van Beek et al. <Citation citationKey="vanBeek2013" bibFile="/bibliographies/108_1_1-bib.json"/> conducted piping experiments on multi-layer sand
...
horizontal permeability of the fine sand (piping) layer, shown in <FigReference parentDocId="108_1_1" figKey="sellmeijer-multi-layer-fndn"/>,
using <EquationReference parentDocId="108_1_1" equationKey="k-h-avg" />.
...
<Equation parentDocId="108_1_1" equationKey="k-h-avg" equation="k_{h,avg} = \frac{k_{h,f}D_f + k_{h,c}D_{c}}{D}" />
...
The average intrinsic permeability is calculated using <EquationReference parentDocId="108_1_1" equationKey="k-avg" />.

<Equation parentDocId="108_1_1" equationKey="k-avg" equation="k_{avg} = k_{h,avg} \left(\frac{μ}{γ_w}\right)" />
...
calculations is the most likely (or mode) value. <FigReference parentDocId="108_1_1" figKey="sellmeijer-single-layer-deterministic"/> illustrates the deterministic
...
values used for subsequent calculations are the most likely (or mode) values. <FigReference parentDocId="108_1_1" figKey="sellmeijer-multi-layer-deterministic"/>
...
the minimum, most likely, and maximum values. <FigReference parentDocId="108_1_1" figKey="sellmeijer-single-layer-probabilistic-no-risk"/> illustrates the probabilistic
...
<FigReference parentDocId="108_1_1" figKey="sellmeijer-multi-layer-probabilistic-no-risk"/> illustrates the probabilistic input for multi-layer aquifer without using @RISK.
...
distribution entered in the third column. <FigReference parentDocId="108_1_1" figKey="sellmeijer-single-layer-probabilistic-risk"/> illustrates the
...
are the mean for the @RISK distribution entered in the third column. <FigReference parentDocId="108_1_1" figKey="sellmeijer-multi-layer-probabilistic-risk"/>
...
Step 4 calculates the field critical horizontal gradient for BEP progression as illustrated in <FigReference parentDocId="108_1_1" figKey="sellmeijer-critical-gradient-terms"/>.

<EquationReference parentDocId="108_1_1" equationKey="i-ch" />, for the critical horizontal gradient for BEP progression (_i<sub>ch</sub>_), is composed 
...
<Equation parentDocId="108_1_1" equationKey="i-ch" equation="i_{ch} = \left(F_R\right) \left(F_S\right) \left(F_G\right)" />
...
coefficient of uniformity (_U_) and is calculated using <EquationReference parentDocId="108_1_1" equationKey="F-R" />.

<Equation parentDocId="108_1_1" equationKey="F-R" equation="F_R = η \left(\frac{γ'_p}{γ_w}\right) \tanθ \left(\frac{RD}{72.5}\right)^{0.35} \left(\frac{U}{1.81}\right)^{0.13} \left(\frac{KAS}{49.2}\right)^{-0.02}" />
...
Since it is easier to estimate the specific gravity of soil particles than the submerged unit weight of soil particles, the substitution in <EquationReference parentDocId="108_1_1" equationKey="SG-sub" />
is made to the equation for _F<sub>R</sub>_.

<Equation parentDocId="108_1_1" equationKey="SG-sub" equation="\frac{γ'_p}{γ_w} = G_s - 1" />
...
Van Beek et al. <Citation citationKey="vanBeek2010" bibFile="/bibliographies/108_1_1-bib.json"/> indicate that _KAS_ and _U_ appear less important than other
...
terms from the equation for FR as illustrated in <FigReference parentDocId="108_1_1" figKey="sellmeijer-critical-gradient-terms-no-u-kas"/>.
...
and the intrinsic permeability of the piping layer (_κ_) and is calculated using <EquationReference parentDocId="108_1_1" equationKey="scale-factor" />.

<Equation parentDocId="108_1_1" equationKey="scale-factor" equation="F_S = \left(\frac{d_{70}}{κL}\right)^{\frac{1}{3}} \left(\frac{0.000208}{d_{70}}\right)^{0.6}" />
...
<EquationReference parentDocId="108_1_1" equationKey="F-G" />.

<Equation parentDocId="108_1_1" equationKey="F-G" equation="F_G = 0.91 \left(\frac{D}{L}\right)^{\frac{0.28}{\left(\frac{D}{L}\right)^{2.8} - 1} + 0.04}" />
...
the model test parameters. Van Beek et al. <Citation citationKey="vanBeek2015" bibFile="/bibliographies/108_1_1-bib.json"/> found that 3D configurations
...
two scenarios are illustrated in <FigReference parentDocId="108_1_1" figKey="sellmeijer-field-gradient-reduction"/>
and <FigReference parentDocId="108_1_1" figKey="sellmeijer-field-gradient-no-reduction"/>.
...
<Equation parentDocId="108_1_1" equationKey="i-avf" equation="i_{avf} = \frac{∆H}{L} = \frac{HW - TW}{L}" />
...
<Equation parentDocId="108_1_1" equationKey="FS-progression" equation="i_{avf} = \frac{∆H}{L} = \frac{HW - TW}{L}" />
...
For deterministic and probabilistic analyses, cells with _FS_ less than 1 have an orange background. <FigReference parentDocId="108_1_1" figKey="sellmeijer-deterministic-tabular-output"/>
illustrates the deterministic tabular output, and <FigReference parentDocId="108_1_1" figKey="sellmeijer-probabilistic-tabular-output"/> illustrates the
...
(red shaded line). <FigReference parentDocId="108_1_1" figKey="sellmeijer-deterministic-graphical-output"/> illustrates the deterministic graphical output.
...
<FigReference parentDocId="108_1_1" figKey="sellmeijer-deterministic-plot-options"/> illustrates the plot options for this chart. The maximum value for the 
...
background for deterministic analysis. <FigReference parentDocId="108_1_1" figKey="sellmeijer-probabilistic-graphical-output"/> illustrates the graphical output
...
<FigReference parentDocId="108_1_1" figKey="sellmeijer-probabilistic-plot-options"/> illustrates the plot options for this chart. The vertical reference 
