...
al. <Citation citationKey="vanBeek2009" bibFile="/bibliographies/108_1_1-bib.json"/> provides guidance for visual estimation of _KAS_ as illustrated
...
<Equation parentDocId="108_1_1" equationKey="K-f" equation="K_{f} = k_{h,f} \left(\frac{μ}{γ_w}\right)" />
...
background. Van Beek et al. <Citation citationKey="vanBeek2012" bibFile="/bibliographies/108_1_1-bib.json"/> conducted piping experiments on multi-layer sand
...
terms from the equation for _F<sub>R</sub>_ as illustrated in <FigReference parentDocId="108_1_1" figKey="sellmeijer-critical-gradient-terms-no-u-kas"/>.
...
{" "}<EquationNoRef equation="\left(\frac{D}{L}\right)" inline={true}/> and is calculated using <EquationReference parentDocId="108_1_1" equationKey="F-G" />.
