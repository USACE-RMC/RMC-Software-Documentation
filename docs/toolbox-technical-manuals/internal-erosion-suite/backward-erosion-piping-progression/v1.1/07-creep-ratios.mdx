...
The line of creep (L) for Bligh’s method is calculated using <EquationReference parentDocId="108_1_1" equationKey="L" />. The
weighted line of creep for Lane’s method (LW) is calculated using <EquationReference parentDocId="108_1_1" equationKey="L-W" />.
