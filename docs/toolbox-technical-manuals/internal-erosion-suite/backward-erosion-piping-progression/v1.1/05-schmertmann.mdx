...
Schmertmann <Citation citationKey="Schmertmann2000" bibFile="/bibliographies/108_1_1-bib.json"/> developed an approach for estimating the factor of safety
...
pipe progression is given in <EquationReference parentDocId="108_1_1" equationKey="fs-pipe-progression" />:

<Equation parentDocId="108_1_1" equationKey="fs-pipe-progression" equation="FS = \left(\frac{C_D C_L C_S C_K C_γ C_Z C_α i_{\textit{pmt}}}{C_R i_f}\right)" />
...
in <TableReference parentDocId="108_1_1" tableKey="schmertmann-reference-values"/>.
...
laboratory flume tests were not conducted, shown in <EquationReference parentDocId="108_1_1" equationKey="i-pmt" />
and <FigReference parentDocId="108_1_1" figKey="schmertmann-lab-critical-gradients"/>.

<Equation parentDocId="108_1_1" equationKey="i-pmt" equation="i_{pmt} = 0.05 + 0.183(C_u - 1)" />
...
To assess the likelihood of BEP progression, Robbins and Sharp <Citation citationKey="Robbins2016" bibFile="/bibliographies/108_1_1-bib.json"/> compiled
all the data in Schmertmann <Citation citationKey="Schmertmann2000" bibFile="/bibliographies/108_1_1-bib.json"/> and developed a probabilistic chart for
determining ipmt, again relative to the reference values, as shown in <FigReference parentDocId="108_1_1" figKey="schmertmann-lab-probabilities"/>.
Robbins and O’Leary <Citation citationKey="Robbins2020" bibFile="/bibliographies/108_1_1-bib.json"/> expanded this chart to include 0 percent and 100
...
for a given field scenario as shown in <EquationReference parentDocId="108_1_1" equationKey="i-pmt-calculation" />.

<Equation parentDocId="108_1_1" equationKey="i-pmt-calculation" equation="i_{pmt} = \frac{{C_R}{i_f}} {{C_D}{C_L}{C_S}{C_K}{C_γ}{C_Z}{C_α}}" />

The probabilistic chart from Robbins and Sharp <Citation citationKey="Robbins2016" bibFile="/bibliographies/108_1_1-bib.json"/> shows that the uncertainty
...
be used and No if @RISK is not used. The three possible scenarios are illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-step1-deterministic"/>
through <FigReference parentDocId="108_1_1" figKey="schmertmann-step1-probabilistic-risk"/>.
...
angle of the pipe path (_α_). The adjusted Schmertmann method uses the probabilistic chart of Robbins and Sharp <Citation citationKey="Robbins2016" bibFile="/bibliographies/108_1_1-bib.json"/>,
expanded by Robbins and O’Leary <Citation citationKey="Robbins2020" bibFile="/bibliographies/108_1_1-bib.json"/>, for both the deterministic and probabilistic
...
value. <FigReference parentDocId="108_1_1" figKey="schmertmann-step2-deterministic"/> illustrates the deterministic input.
...
values. <FigReference parentDocId="108_1_1" figKey="schmertmann-step2-probabilistic-no-risk"/> illustrates probabilistic input without using @RISK.
...
column. <FigReference parentDocId="108_1_1" figKey="schmertmann-step2-probabilistic-risk"/> illustrates the probabilistic input without using @RISK.
...
The remaining input for step 2 addresses pipe path geometry as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-pipe-path"/> and
...
that progress downwards. Based on Schmertmann <Citation citationKey="Schmertmann2000" bibFile="/bibliographies/108_1_1-bib.json"/>, the range for _α_ is
...
and the transformed length of the piping path in the field (_Lf_) is calculated using <EquationReference parentDocId="108_1_1" equationKey="pipe-path-transformed-length" />.

<Equation parentDocId="108_1_1" equationKey="pipe-path-transformed-length" equation="L_f = \frac{L} {(R_{kf})^{0.5}}" />
...
in <FigReference parentDocId="108_1_1" figKey="schmertmann-flume-gradient"/>. In practice, laboratory flume tests are rarely conducted to measure the critical
horizontal gradient, and the linear relationship proposed by Schmertmann <Citation citationKey="Schmertmann2000" bibFile="/bibliographies/108_1_1-bib.json"/> is
...
line from Robbins and Sharp <Citation citationKey="Robbins2016" bibFile="/bibliographies/108_1_1-bib.json"/> is used in lieu of Schmertmann’s no-test default
line using <EquationReference parentDocId="108_1_1" equationKey="i-pmt-50-quantile" /> as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-lab-gradient"/>.

<Equation parentDocId="108_1_1" equationKey="pipe-path-transformed-length" equation="i_{pmt} = 0.1358(C_u) + 0.002" />
...
gradient as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-field-corrections"/>. The correction factors for foundation depth, seepage path
length, grain size, anisotropy, and soil density are estimated using <EquationReference parentDocId="108_1_1" equationKey="depth-length-factor" />,

<EquationReference parentDocId="108_1_1" equationKey="total-pipe-length-factor" />, <EquationReference parentDocId="108_1_1" equationKey="grain-size-factor" />, 
<EquationReference parentDocId="108_1_1" equationKey="anisotropic-permeability-factor" />, and <EquationReference parentDocId="108_1_1" equationKey="density-factor" />. 
...
<Equation parentDocId="108_1_1" equationKey="depth-length-factor" equation="C_D = \frac{\left(\frac{D}{L_f}\right)^{\frac{0.2}{\left(\frac{D}{L_f}\right)^2-1}}}{\left(\frac{1 ft}{5 ft}\right)^{\frac{0.2}{\left(\frac{1 ft}{5 ft}\right)^2-1}}} = \frac{\left(\frac{D}{L_f}\right)^{\frac{0.2}{\left(\frac{D}{L_f}\right)^2-1}}}{1.4}" />

<Equation parentDocId="108_1_1" equationKey="total-pipe-length-factor" equation="C_L = \left(\frac{5 ft}{L_f}\right)^{0.2}" />

<Equation parentDocId="108_1_1" equationKey="grain-size-factor" equation="C_S = \left(\frac{d_{10f}}{0.20 mm}\right)^{0.2}" />

<Equation parentDocId="108_1_1" equationKey="anisotropic-permeability-factor" equation="C_K = \left(\frac{1.5}{\frac{k_h}{k_v}}\right)^{0.5} = \left(\frac{1.5}{R_{kf}}\right)^{0.5}" />

<Equation parentDocId="108_1_1" equationKey="density-factor" equation="C_γ = 1 + 0.4\left(\frac{D_{rf}}{100}-0.6\right)" />
...
as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-no-underlayer"/>. Cells that do not apply have a gray background. If a higher permeability
...
Schmertmann <Citation citationKey="Schmertmann2000" bibFile="/bibliographies/108_1_1-bib.json"/> provided _C<sub>Z</sub>_ as a function of _D∕r_ for _k<sub>u</sub>∕k<sub>p</sub>_
...
flume. CZ is obtained from two-way linear interpolation using these three curves as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-underlayer"/>.
Fell et al. <Citation citationKey="Fell2008" bibFile="/bibliographies/108_1_1-bib.json"/> suggests using _C<sub>Z</sub>_ = 1 since r is very small and _D∕r_ is typically
...
Fell et al. <Citation citationKey="Fell2008" bibFile="/bibliographies/108_1_1-bib.json"/> suggested using r = 2.5 to 10 mm, where the horizontal critical gradient
...
The field horizontal critical gradient is calculated using the above correction factors and <EquationReference parentDocId="108_1_1" equationKey="field-critical-gradient" />
as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-field-gradient"/>.

<Equation parentDocId="108_1_1" equationKey="field-critical-gradient" equation="i_{ch} = \left(\frac{C_D C_L C_S C_K C_γ C_Z}{C_R}\right)i_{pmt}" />
...
have a gray background. If the pipe path inclination is not zero, Schmertmann <Citation citationKey="Schmertmann2000" bibFile="/bibliographies/108_1_1-bib.json"/> provided
...
0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, and 0.50 or greater, as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-pipe-path-inclination"/>. _i<sub>pα</sub>_ is
obtained from two-way linear interpolation using these ten curves. The back-calculated adjustment for pipe path inclination uses <EquationReference parentDocId="108_1_1" equationKey="pipe-path-inclination-factor" />.

<Equation parentDocId="108_1_1" equationKey="pipe-path-inclination-factor" equation="C_α = \frac{i_{pα}}{i_{po}}" />
...
using <EquationReference parentDocId="108_1_1" equationKey="i-α" />.

<Equation parentDocId="108_1_1" equationKey="i-α" equation="i_{pα} = i_{ch} C_α" />

If the pipe path is horizontal, _i<sub>pα</sub>_ = _i<sub>ch</sub>_ because _C<sub>α</sub>_ = 1.

Schmertmann’s adjusted model applies to 2D seepage with plane or ditch exits parallel to the embankment centerline. Van Beek et al. <Citation citationKey="vanBeek2015" bibFile="/bibliographies/108_1_1-bib.json"/> found
...
3D flow, input a user-specified gradient reduction factor (GRF). Cells that do not apply have a gray background. <FigReference parentDocId="108_1_1" figKey="schmertmann-gradient-reduction-factor"/>
and <FigReference parentDocId="108_1_1" figKey="schmertmann-gradient-no-reduction-factor"/> illustrate the two scenarios.
...
Robbins and Sharp <Citation citationKey="Robbins2016" bibFile="/bibliographies/108_1_1-bib.json"/> presented the results of a best-fit quantile regression analysis
from the individual laboratory flume tests, which were expanded by Robbins and O'Leary <Citation citationKey="Robbins2020" bibFile="/bibliographies/108_1_1-bib.json"/>
...
in <FigReference parentDocId="108_1_1" figKey="schmertmann-cdf"/>.
...
using <EquationReference parentDocId="108_1_1" equationKey="i-avf" />.

<Equation parentDocId="108_1_1" equationKey="i-avf" equation="i_{avf} = \frac{ΔH}{L} = \frac{HW-TW}{L}" />
...
The FS against BEP progression is calculated using <EquationReference parentDocId="108_1_1" equationKey="FS-progression" />.

<Equation parentDocId="108_1_1" equationKey="FS-progression" equation="FS = \frac{i_{pα}}{i_{avg}}" />
...
cells with FS less than 1 have an orange background. <FigReference parentDocId="108_1_1" figKey="schmertmann-deterministic-output"/> illustrates the deterministic
tabular output, and <FigReference parentDocId="108_1_1" figKey="schmertmann-probabilistic-output"/> illustrates the probabilistic tabular output without using @RISK.
...
<FigReference parentDocId="108_1_1" figKey="schmertmann-deterministic-graph"/> illustrates the deterministic graphical output.
...
<FigReference parentDocId="108_1_1" figKey="schmertmann-deterministic-plot-options"/> illustrates the plot options this chart. The maximum value for the primary 
...
Because the adjusted Schmertmann method uses the probabilistic chart of Robbins and Sharp <Citation citationKey="Robbins2016" bibFile="/bibliographies/108_1_1-bib.json"/>,
expanded by Robbins and O’Leary <Citation citationKey="Robbins2020" bibFile="/bibliographies/108_1_1-bib.json"/>, a probability of BEP progression is calculated
for both the deterministic and probabilistic methods as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-deterministic-graphical-output"/>
and <FigReference parentDocId="108_1_1" figKey="schmertmann-probabilistic-graphical-output"/>, respectively. The mean probability of BEP progression is plotted as a
...
level using dashed lines, as shown in <FigReference parentDocId="108_1_1" figKey="schmertmann-probabilistic-graphical-output"/>.
...
<FigReference parentDocId="108_1_1" figKey="schmertmann-graphical-output-plot-options"/> illustrates the plot options for the charts 
in <FigReference parentDocId="108_1_1" figKey="schmertmann-deterministic-graphical-output"/> and 
<FigReference parentDocId="108_1_1" figKey="schmertmann-probabilistic-graphical-output"/>. The vertical reference elevations and minimum and maximum values for the 
x-axis (headwater level) are the same as <FigReference parentDocId="108_1_1" figKey="schmertmann-deterministic-plot-options"/>. Only the maximum value for the y-axis 
