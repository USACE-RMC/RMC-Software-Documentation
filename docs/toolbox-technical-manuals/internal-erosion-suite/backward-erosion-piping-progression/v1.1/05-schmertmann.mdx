...
<EquationReference parentDocId="108_1_1" equationKey="fs-pipe-progression" /> and <EquationReference parentDocId="108_1_1" equationKey="i-pmt" /> 
...
is calculated, and the transformed length of the piping path in the field (_L<sub>f</sub>_) is calculated using <EquationReference parentDocId="108_1_1" equationKey="pipe-path-transformed-length" />.
...
line using <EquationReference parentDocId="108_1_1" equationKey="pipe-path-transformed-length" /> as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-lab-gradient"/>.
...
Schmertmann <Citation citationKey="Schmertmann2000" bibFile="/bibliographies/108_1_1-bib.json"/> provided _C<sub>Z</sub>_ as a function
...
as illustrated in <FigReference parentDocId="108_1_1" figKey="schmertmann-underlayer"/>. Fell et al. <Citation citationKey="Fell2008" bibFile="/bibliographies/108_1_1-bib.json"/>
...
For very thin erodible layers (less than a couple of feet), Fell et al. <Citation citationKey="Fell2008" bibFile="/bibliographies/108_1_1-bib.json"/> suggested using r = 2.5
