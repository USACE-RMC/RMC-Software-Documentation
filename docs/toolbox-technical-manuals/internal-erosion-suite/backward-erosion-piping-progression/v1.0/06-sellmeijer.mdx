...
<Equation equationKey="K-f" equation="K_{f} = k_{h,f} \left(\frac{μ}{γ_w}\right)" />
...
<Equation equationKey="k-h-avg" equation="k_{h,avg} = \frac{k_{h,f}D_f + k_{h,c}D_{c}}{D}" />
...
<Equation equationKey="k-avg" equation="k_{avg} = k_{h,avg} \left(\frac{μ}{γ_w}\right)" />
...
<FigReference figKey="sellmeijer-multi-layer-probabilistic-no-risk"/> illustrates the probabilistic input for multi-layer aquifer without using @RISK.
...
<EquationReference equationKey="i-ch" />, for the critical horizontal gradient for BEP progression (_i<sub>ch</sub>_), is composed 
...
<Equation equationKey="i-ch" equation="i_{ch} = \left(F_R\right) \left(F_S\right) \left(F_G\right)" />
...
<Equation equationKey="F-R" equation="F_R = η \left(\frac{γ'_p}{γ_w}\right) \tanθ \left(\frac{RD}{72.5}\right)^{0.35} \left(\frac{U}{1.81}\right)^{0.13} \left(\frac{KAS}{49.2}\right)^{-0.02}" />
...
<Equation equationKey="scale-factor" equation="F_S = \left(\frac{d_{70}}{κL}\right)^{\frac{1}{3}} \left(\frac{0.000208}{d_{70}}\right)^{0.6}" />
...
<Equation equationKey="F-G" equation="F_G = 0.91 \left(\frac{D}{L}\right)^{\frac{0.28}{\left(\frac{D}{L}\right)^{2.8} - 1} + 0.04}" />
...
<Equation equationKey="i-avf" equation="i_{avf} = \frac{∆H}{L} = \frac{HW - TW}{L}" />
...
<Equation equationKey="FS-progression" equation="i_{avf} = \frac{∆H}{L} = \frac{HW - TW}{L}" />
...
<FigReference figKey="sellmeijer-deterministic-plot-options"/> illustrates the plot options for this chart. The maximum value for the 
...
<FigReference figKey="sellmeijer-probabilistic-plot-options"/> illustrates the plot options for this chart. The vertical reference 
