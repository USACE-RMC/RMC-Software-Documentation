...
(_L_). For net hydraulic head (_H_) less than Hc, progression of the pipe reaches a stable condition. For _H_ greater than _H<sub>c</sub>_, the piping
...
The method of analysis is the same as the Schmertmann worksheet.
...
and multiple images of each soil sample should be analyzed. In practice, optical images of soil samples are rarely conducted to obtain KAS. Van Beek et
al. <Citation citationKey="vanBeek2009" bibFile="/bibliographies/108_1_0-bib.json"/> provides guidance for visual estimation of KAS as illustrated
...
<Equation parentDocId="108_1_0" equationKey="K-f" equation="K_{f} = k_{h,f} \frac{μ}{γ_w}" />
...
background. Van Beek et al. <Citation citationKey="vanBeek2013" bibFile="/bibliographies/108_1_0-bib.json"/> conducted piping experiments on multi-layer sand
