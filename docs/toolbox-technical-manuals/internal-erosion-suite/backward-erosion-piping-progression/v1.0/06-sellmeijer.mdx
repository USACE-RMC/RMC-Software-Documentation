...
terms from the equation for _F<sub>R</sub>_ as illustrated in <FigReference parentDocId="108_1_0" figKey="sellmeijer-critical-gradient-terms-no-u-kas"/>.
...
{" "}<EquationNoRef equation="\left(\frac{D}{L}\right)" inline={true}/> and is calculated using <EquationReference parentDocId="108_1_0" equationKey="F-G" />.
