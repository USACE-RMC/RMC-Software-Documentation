...
<EquationReference equationKey="i-pmt" /> can be used along with the correction factors to assess the FS for BEP progression in the field. While this
...
<FigReference figKey="schmertmann-deterministic-plot-options" /> illustrates the plot options this chart. The maximum value for the primary y-axis (FS
...
<FigReference figKey="schmertmann-graphical-output-plot-options" /> illustrates the plot options for the charts in
<FigReference figKey="schmertmann-deterministic-graphical-output" /> and
<FigReference figKey="schmertmann-probabilistic-graphical-output" />. The vertical reference elevations and minimum and maximum values for the x-axis
(headwater level) are the same as
<FigReference figKey="schmertmann-deterministic-plot-options" />. Only the maximum value for the y-axis (probability of BEP progression) is
user-specified.
