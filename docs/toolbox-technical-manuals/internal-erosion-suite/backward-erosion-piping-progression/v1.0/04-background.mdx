...
head, _iavf = ΔH/L_, as illustrated in <FigReference parentDocId="108_1_0" figKey="average-horizontal-gradient"></FigReference>, can be compared to the
...
and the adjusted calculation rule of Sellmeijer et al. <Citation citationKey="Sellmeijer2011" bibFile="/bibliographies/108_1_0-bib.json"/>, in
addition to the creep ratio methods of Bligh <Citation citationKey="Bligh1910" bibFile="/bibliographies/108_1_0-bib.json"/> and Lane <Citation citationKey="Lane1935" bibFile="/bibliographies/108_1_0-bib.json"/>.
Applying these methods correctly requires an understanding of the context from which each method was developed. Robbins and van Beek <Citation citationKey="vanBeek2015" bibFile="/bibliographies/108_1_0-bib.json"/>
