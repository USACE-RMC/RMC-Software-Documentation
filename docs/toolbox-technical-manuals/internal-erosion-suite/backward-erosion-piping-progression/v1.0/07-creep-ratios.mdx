...
Creep ratio methods such as Bligh (1910) <Citation citationKey="Bligh1910"/> and
Lane (1935) <Citation citationKey="Lane1935"/> are empirical methods still used by some practitioners to
...
<Figure
  ...
  src="/figures/toolbox-technical-manuals/internal-erosion-suite/backward-erosion-piping-progression/v1.0/figure57.png"
  alt="Levee geometry for line-of-creep methods."
  caption="Levee geometry for line-of-creep methods."
></Figure>
...
appropriate for a compromised confining layer overlying a confined aquifer. Duncan et al. (2011) <Citation citationKey="Duncan2011"/>
...
> _L<sub>1</sub>_ = length (feet) of upstream/floodside impervious blanket or berm  
> _L<sub>2</sub>_ = length (feet) of downstream/landside impervious blanket or berm  
> _W_ = width (feet) of base of concrete weir or impervious embankment  

<Figure
  figKey="creep-input"
  src="/figures/toolbox-technical-manuals/internal-erosion-suite/backward-erosion-piping-progression/v1.0/figure58.png"
  alt="Step 1 of Creep Ratios worksheet: Line-of-creep input."
  caption="Step 1 of Creep Ratios worksheet: Line-of-creep input."
></Figure>

## Minimum Creep Ratio

Step 2 characterizes the foundation to obtain the minimum (or safe) creep ratio for both empirical methods from
Lane (1935) <Citation citationKey="Lane1935"/> based on soil type as illustrated
...
<Figure
  ...
  src="/figures/toolbox-technical-manuals/internal-erosion-suite/backward-erosion-piping-progression/v1.0/figure59.png"
  alt="Step 2 of Creep Ratios worksheet: Material input."
  caption="Step 2 of Creep Ratios worksheet: Material input."
></Figure>
...
<Equation equationKey="C" equation="C = \frac{L}{ΔH} = \frac{L}{HW-TW}" />

<Equation
  equationKey="C-W"
  equation="C_W = \frac{L_W}{ΔH} = \frac{L_W}{HW-TW}"
/>
...
> _L<sub>W</sub>_ = line of creep for Lane’s method (feet)  
...
<Figure
  ...
  src="/figures/toolbox-technical-manuals/internal-erosion-suite/backward-erosion-piping-progression/v1.0/figure60.png"
  alt="Step 3 of Creep Ratios worksheet: Deterministic tabular output."
  caption="Step 3 of Creep Ratios worksheet: Deterministic tabular output."
></Figure>
...
<Figure
  ...
  src="/figures/toolbox-technical-manuals/internal-erosion-suite/backward-erosion-piping-progression/v1.0/figure61.png"
  alt="Step 3 of Creep Ratios worksheet: Deterministic graphical output."
  caption="Step 3 of Creep Ratios worksheet: Deterministic graphical output."
></Figure>

<FigReference figKey="creep-deterministic-plot options" /> illustrates the plot options
for this chart. The maximum value for the y-axis (creep ratio) and minimum and maximum
values for the x-axis (headwater level) are user-specified. Users can input up to
five vertical reference elevations, and user-specified labels displayed at the top
of the chart.

<Figure
  figKey="creep-deterministic-plot options"
  src="/figures/toolbox-technical-manuals/internal-erosion-suite/backward-erosion-piping-progression/v1.0/figure62.png"
  alt="Step 3 of Creep Ratios worksheet: Plot options for deterministic graphical output."
  caption="Step 3 of Creep Ratios worksheet: Plot options for deterministic graphical output."
></Figure>
...
<Figure
  ...
  src="/figures/toolbox-technical-manuals/internal-erosion-suite/backward-erosion-piping-progression/v1.0/figure63.png"
  alt="Step 3 of Creep Ratios worksheet: Filtering data."
  caption="Step 3 of Creep Ratios worksheet: Filtering data."
></Figure>
