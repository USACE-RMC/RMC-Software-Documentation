...
Creep ratio methods such as Bligh <Citation citationKey="Bligh1910" bibFile="/bibliographies/108_1_0-bib.json"/> and
Lane <Citation citationKey="Lane1935" bibFile="/bibliographies/108_1_0-bib.json"/> are empirical methods still used by some practitioners to
...
etc. as illustrated in <FigReference parentDocId="108_1_0" figKey="creep-geometry"/>.
...
appropriate for a compromised confining layer overlying a confined aquifer. Duncan et al. <Citation citationKey="Duncan2011" bibFile="/bibliographies/108_1_0-bib.json"/>
...
Step 1 calculates the line of creep (seepage path length) as illustrated in <FigReference parentDocId="108_1_0" figKey="creep-input"/>. The
...
The line of creep (_L_) for Bligh’s method is calculated using <EquationReference parentDocId="108_1_0" equationKey="L" />. The
weighted line of creep for Lane’s method (_L<sub>W</sub>_) is calculated using <EquationReference parentDocId="108_1_0" equationKey="L-W" />.

<Equation parentDocId="108_1_0" equationKey="L" equation="L = L_1 + W + L_2 + 2D" />

<Equation parentDocId="108_1_0" equationKey="L-W" equation="L_W = \frac{L_1 + W + L_2}{3} + 2D" />
...
Lane <Citation citationKey="Lane1935" bibFile="/bibliographies/108_1_0-bib.json"/> based on soil type as illustrated
in <FigReference parentDocId="108_1_0" figKey="creep-material-input"/>. Use the drop-down list to select the material that best represents
...
field horizontal critical gradient is calculated using <EquationReference parentDocId="108_1_0" equationKey="i-ch-bligh" />
and <EquationReference parentDocId="108_1_0" equationKey="i-ch-lane" /> for Bligh’s method and Lane’s method, respectively. For _D_ greater
than zero, “N/A” displays for _i<sub>ch</sub>_.

<Equation parentDocId="108_1_0" equationKey="i-ch-bligh" equation="i_{ch} = \frac{1}{C_{min}}" />

<Equation parentDocId="108_1_0" equationKey="i-ch-lane" equation="i_{ch} = \frac{1}{C_{W,min}}" />
...
consideration. The creep ratio for Bligh’s method (_C_) is calculated using <EquationReference parentDocId="108_1_0" equationKey="C" />.
The weighted creep ratio for Lane’s method (_C<sub>W</sub>_) is calculated using <EquationReference parentDocId="108_1_0" equationKey="C-W" />.

<Equation parentDocId="108_1_0" equationKey="C" equation="i_{ch} = \frac{1}{C_{W,min}}" />

<Equation parentDocId="108_1_0" equationKey="C-W" equation="i_{ch} = \frac{1}{C_{W,min}}" />
...
minimum value have an orange background. <FigReference parentDocId="108_1_0" figKey="creep-deterministic-tabular-output"/> illustrates the
tabular summary.
...
(or safe) creep ratios for each method. <FigReference parentDocId="108_1_0" figKey="creep-deterministic-graphical-output"/> illustrates the
...
<FigReference parentDocId="108_1_0" figKey="creep-deterministic-plot options"/> illustrates the plot options for this chart. The maximum 
...
illustrated in <FigReference parentDocId="108_1_0" figKey="creep-deterministic-filtering"/>. For example, if only the results from the Bligh’s
