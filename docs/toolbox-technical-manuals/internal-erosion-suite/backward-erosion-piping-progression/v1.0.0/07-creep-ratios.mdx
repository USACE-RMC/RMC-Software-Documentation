...
Creep ratio methods such as Bligh <Citation citationKey="Bligh1910" bibFile="/bibliographies/108_1_0_0-bib.json"/> and
Lane <Citation citationKey="Lane1935" bibFile="/bibliographies/108_1_0_0-bib.json"/> are empirical methods still used by some practitioners to
...
etc. as illustrated in <FigReference parentDocId="108_1_0_0" figKey="creep-geometry"/>.
...
appropriate for a compromised confining layer overlying a confined aquifer. Duncan et al. <Citation citationKey="Duncan2011" bibFile="/bibliographies/108_1_0_0-bib.json"/>
...
Step 1 calculates the line of creep (seepage path length) as illustrated in <FigReference parentDocId="108_1_0_0" figKey="creep-input"/>. The
...
Lane <Citation citationKey="Lane1935" bibFile="/bibliographies/108_1_0_0-bib.json"/> based on soil type as illustrated
in <FigReference parentDocId="108_1_0_0" figKey="creep-material-input"/>. Use the drop-down list to select the material that best represents
...
minimum value have an orange background. <FigReference parentDocId="108_1_0_0" figKey="creep-deterministic-tabular-output"/> illustrates the
tabular summary.
...
(or safe) creep ratios for each method. <FigReference parentDocId="108_1_0_0" figKey="creep-deterministic-graphical-output"/> illustrates the
...
<FigReference parentDocId="108_1_0_0" figKey="creep-deterministic-plot-options"/> illustrates the plot options for this chart. The maximum 
...
illustrated in <FigReference parentDocId="108_1_0_0" figKey="creep-deterministic-filtering"/>. For example, if only the results from the Bligh’s
