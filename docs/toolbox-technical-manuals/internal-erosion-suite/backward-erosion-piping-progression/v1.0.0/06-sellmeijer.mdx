...
al. <Citation citationKey="Sellmeijer2011" bibFile="/bibliographies/108_1_0_0-bib.json"/>. The adjusted calculation rule extended and updated the piping model
...
piping model testing parameters shown in <TableReference parentDocId="108_1_0_0" tableKey="sellmeijer-parameter-limits"/>.
...
sand (_θ_), and White’s constant (_η_) as illustrated in <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-discrete-input"/>. The bedding angle and White’s
...
al. <Citation citationKey="vanBeek2009" bibFile="/bibliographies/108_1_0_0-bib.json"/> provides guidance for visual estimation of KAS as illustrated
in <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-KAS-estimate"/>.
...
values. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-deterministic-input"/> illustrates the deterministic input.
...
values. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-probabilistic-input-no-risk"/> illustrates the probabilistic input without using @RISK.
...
column. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-probabilistic-input-risk"/> illustrates the probabilistic input using @RISK.
...
background. Van Beek et al. <Citation citationKey="vanBeek2013" bibFile="/bibliographies/108_1_0_0-bib.json"/> conducted piping experiments on multi-layer sand
...
horizontal permeability of the fine sand (piping) layer, shown in <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-multi-layer-fndn"/>, using Equation 17.
...
calculations is the most likely (or mode) value. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-single-layer-deterministic"/> illustrates the deterministic
...
values used for subsequent calculations are the most likely (or mode) values. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-multi-layer-deterministic"/>
...
the minimum, most likely, and maximum values. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-single-layer-probabilistic-no-risk"/> illustrates the probabilistic
...
<FigReference parentDocId="108_1_0_0" figKey="sellmeijer-multi-layer-probabilistic-no-risk"/> illustrates the probabilistic input for multi-layer aquifer without using @RISK.
...
distribution entered in the third column. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-single-layer-probabilistic-risk"/> illustrates the
...
are the mean for the @RISK distribution entered in the third column. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-multi-layer-probabilistic-risk"/>
...
Step 4 calculates the field critical horizontal gradient for BEP progression as illustrated in <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-critical-gradient-terms"/>.
...
Van Beek et al. <Citation citationKey="vanBeek2010" bibFile="/bibliographies/108_1_0_0-bib.json"/> indicate that _KAS_ and _U_ appear less important than other
...
terms from the equation for FR as illustrated in <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-critical-gradient-terms-no-u-kas"/>.
...
the model test parameters. Van Beek et al. <Citation citationKey="vanBeek2015" bibFile="/bibliographies/108_1_0_0-bib.json"/> found that 3D configurations
...
two scenarios are illustrated in <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-field-gradient-reduction"/>
and <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-field-gradient-no-reduction"/>.
...
For deterministic and probabilistic analyses, cells with _FS_ less than 1 have an orange background. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-deterministic-tabular-output"/>
illustrates the deterministic tabular output, and <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-probabilistic-tabular-output"/> illustrates the
...
(red shaded line). <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-deterministic-graphical-output"/> illustrates the deterministic graphical output.
...
<FigReference parentDocId="108_1_0_0" figKey="sellmeijer-deterministic-plot-options"/> illustrates the plot options for this chart. The maximum value for the 
...
background for deterministic analysis. <FigReference parentDocId="108_1_0_0" figKey="sellmeijer-probabilistic-graphical-output"/> illustrates the graphical output
...
<FigReference parentDocId="108_1_0_0" figKey="sellmeijer-probabilistic-plot-options"/> illustrates the plot options for this chart. The vertical reference 
