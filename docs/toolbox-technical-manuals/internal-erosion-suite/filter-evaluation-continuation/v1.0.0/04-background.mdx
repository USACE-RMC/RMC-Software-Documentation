...
<FigReference parentDocId="107_1_0_0" figKey="particle-retention"></FigReference> illustrates
...
The Federal Emergency Management Agency (FEMA) <Citation citationKey="FEMA2011" bibFile="/bibliographies/107_1_0_0-bib.json"></Citation> defines a filter as a soil gradation that meets both particle retention and drainage criteria.
