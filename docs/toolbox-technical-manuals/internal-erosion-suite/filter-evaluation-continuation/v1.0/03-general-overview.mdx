...
message bar will vary depending on the computer’s settings and installed add-ins. <FigReference parentDocId="107_1_0" figKey="enable-macros"></FigReference> displays examples of different wordings that may appear in the message bar.

<Figure
  parentDocId="107_1_0"
  docId="03-general-overview.mdx"
  figKey="enable-macros"
  src="/figures/toolbox-technical-manuals/filter-evaluation-continuation/figure1.png"
...
title in case multiple copies of the worksheet are created for different analysis scenarios (<FigReference parentDocId="107_1_0" figKey="heading"></FigReference>).
...
<Figure
  ...
  docId="03-general-overview.mdx"
  figKey="heading"
  src="/figures/toolbox-technical-manuals/filter-evaluation-continuation/figure2.png"
...
a user-specified datum along with feet (e.g., ft-MSL [Mean Sea Level]). <FigReference parentDocId="107_1_0" figKey="NAVD88"></FigReference>, <FigReference parentDocId="107_1_0" figKey="NGVD29"></FigReference>, and <FigReference parentDocId="107_1_0" figKey="datum"></FigReference> illustrate
...
<Figure
  ...
  docId="03-general-overview.mdx"
  figKey="NAVD88"
  src="/figures/toolbox-technical-manuals/filter-evaluation-continuation/figure3.png"
...
<Figure
  ...
  docId="03-general-overview.mdx"
  figKey="NGVD29"
  src="/figures/toolbox-technical-manuals/filter-evaluation-continuation/figure4.png"
...
<Figure
  ...
  docId="03-general-overview.mdx"
  figKey="datum"
  src="/figures/toolbox-technical-manuals/filter-evaluation-continuation/figure5.png"
  alt="Headwater and tailwater input: User-specified datum"
  caption="Headwater and tailwater input: User-specified datum."
></Figure>

Most calculation worksheets break down complex analysis into computational steps following a logical sequence (<FigReference parentDocId="107_1_0" figKey="step-banner"></FigReference>). Some simpler
...
are labeled as options (<FigReference parentDocId="107_1_0" figKey="option-banner"></FigReference>).

<Figure
  parentDocId="107_1_0"
  docId="03-general-overview.mdx"
  figKey="step-banner"
  src="/figures/toolbox-technical-manuals/filter-evaluation-continuation/figure6.png"
...
<Figure
  ...
  src="/figures/toolbox-technical-manuals/filter-evaluation-continuation/figure7.png"
