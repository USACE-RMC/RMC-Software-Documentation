...
message bar will vary depending on the computer’s settings and installed add-ins. <FigReference figKey="enable-macros"/> displays examples of different wordings that may appear in the message bar.

<Figure
  docId="03-general-overview.mdx"
  figKey="enable-macros"
  src="figures/toolbox-technical-manuals/internal-erosion-suite/filter-evaluation-continuation/v1.0/figure1.png"
...
title in case multiple copies of the worksheet are created for different analysis scenarios (<FigReference figKey="heading"/>).
The footer of each calculation worksheet contains the version number, which can be cross-referenced with the revision history on the third worksheet.

<Figure
  docId="03-general-overview.mdx"
  figKey="heading"
  src="figures/toolbox-technical-manuals/internal-erosion-suite/filter-evaluation-continuation/v1.0/figure2.png"
...
a user-specified datum along with feet (e.g., ft-MSL [Mean Sea Level]). <FigReference figKey="NAVD88"/>, <FigReference figKey="NGVD29"/>, and <FigReference figKey="datum"/> illustrate
the three possible scenarios.

<Figure
  docId="03-general-overview.mdx"
  figKey="NAVD88"
  src="figures/toolbox-technical-manuals/internal-erosion-suite/filter-evaluation-continuation/v1.0/figure3.png"
...
<Figure
  docId="03-general-overview.mdx"
  figKey="NGVD29"
  src="figures/toolbox-technical-manuals/internal-erosion-suite/filter-evaluation-continuation/v1.0/figure4.png"
...
<Figure
  docId="03-general-overview.mdx"
  figKey="datum"
  src="figures/toolbox-technical-manuals/internal-erosion-suite/filter-evaluation-continuation/v1.0/figure5.png"
  alt="Headwater and tailwater input: User-specified datum"
  caption="Headwater and tailwater input: User-specified datum."
></Figure>

Most calculation worksheets break down complex analysis into computational steps following a logical sequence (<FigReference figKey="step-banner"/>). Some simpler
...
are labeled as options (<FigReference figKey="option-banner"/>).

<Figure
  docId="03-general-overview.mdx"
  figKey="step-banner"
  src="figures/toolbox-technical-manuals/internal-erosion-suite/filter-evaluation-continuation/v1.0/figure6.png"
...
<Figure
  ...
  src="figures/toolbox-technical-manuals/internal-erosion-suite/filter-evaluation-continuation/v1.0/figure7.png"
