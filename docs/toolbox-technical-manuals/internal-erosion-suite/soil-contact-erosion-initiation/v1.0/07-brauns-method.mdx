...
<Figure
  ...
  caption={
    <>
      Critical Darcy velocity for sand below gravel for Brauns (1985) method{' '}
...
Brauns (1985) <Citation citationKey="Brauns1985" /> showed that the critical Froude number is between 0.65 and 0.70 and recommended using the lower value of 0.65,
