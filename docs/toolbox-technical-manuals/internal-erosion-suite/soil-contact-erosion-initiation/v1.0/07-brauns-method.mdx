...
<Figure
  figKey="figure-37"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\soil-contact-erosion-initiation/figure37.png"
...
Step 2 characterizes the base soil. This input includes specific gravity of soil particles (_G__<sub>s</sub>_) and median particle diameter of the
base soil (_d_<sub>50</sub>). The median particle diameter of the base soil (_d_<sub>50</sub>) is informed by the calculated values on the Gradation
worksheet.
...
For deterministic analysis, input only the most likely value of _d_<sub>50</sub>. The mean value used for subsequent calculations is the most likely
(or mode) value. <FigReference figKey="figure-38" /> illustrates the deterministic input.

<Figure
  figKey="figure-38"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\soil-contact-erosion-initiation/figure38.png"
...
distribution represents _d_<sub>50</sub>. The mean value used in subsequent calculations is the average of the minimum, most likely, and maximum
values. <FigReference figKey="figure-39" /> illustrates the probabilistic input without using @RISK.

<Figure
  figKey="figure-39"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\soil-contact-erosion-initiation/figure39.png"
...
For probabilistic analysis using @RISK, input the minimum, most likely, and maximum values of _d_<sub>50</sub>, and use an @RISK formula for a
...
<Figure
  figKey="figure-40"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\soil-contact-erosion-initiation/figure40.png"
...
- _ρ__<sub>s</sub>_ = density of the base soil particles (sand)
- _ρ__<sub>w</sub>_ = density of water
- _g_ = acceleration of gravity
- _d_<sub>50</sub> = median particle size of the base soil (sand)
...
Since it is easier to estimate the specific gravity of soil particles than the submerged density of soil particles, the following substitution is made
 to the equation for _v__<sub>F,cr</sub>_. as shown in <EquationReference equationKey="equation-9" />.
...
- _G__<sub>s</sub>_ = specific gravity of the base soil particles (sand)

Therefore, <EquationReference equationKey="equation-10" /> shows that the equation for _v__<sub>F,cr</sub>_ can be simplified to:
...
<Figure
  figKey="figure-41"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\soil-contact-erosion-initiation/figure41.png"
...
particle diameter of the base soil (_d_<sub>50</sub>). Reference lines for the critical Darcy velocity of flow through the filter (gravel layer) for
porosities of 0.25 and 0.40 display as dashed lines. When a Darcy velocity at a given headwater level plots above the line of critical Darcy velocity
based on the porosity of the filter (gravel layer), the FS is greater than 1, and initiation of soil contact erosion is not predicted.
{"\n"}<FigReference figKey="figure-42" /> illustrates the graphical output of Darcy velocity for deterministic analysis.

<Figure
  figKey="figure-42"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\soil-contact-erosion-initiation/figure42.png"
...
<Figure
  figKey="figure-43"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\soil-contact-erosion-initiation/figure43.png"
...
<Figure
  figKey="figure-44"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\soil-contact-erosion-initiation/figure44.png"
