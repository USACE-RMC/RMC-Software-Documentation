...
- <em>ρ<sub>s</sub></em> = density of the base soil particles (sand)
- <em>ρ<sub>w</sub></em> = density of water
- <em>g</em> = acceleration of gravity
- <em>d</em><sub>50</sub> = median particle size of the base soil (sand)
...
- <em>G<sub>s</sub></em> = specific gravity of the base soil particles (sand)
