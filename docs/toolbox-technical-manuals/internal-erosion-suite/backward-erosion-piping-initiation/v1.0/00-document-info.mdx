...
citationGuide: "T. M. O'Leary, <i>RMC Backward Erosion Piping (Initiation) Toolbox Technical Manual</i>, Lakewood, CO: U.S. Army Corps of Engineers, Risk Management Center, 2025. Accessed on <i>{enter current date here}</i>."
---
