...
reportSubjectTerms:
  ['Internal erosion', 'backward erosion piping', 'initiation', 'hydraulic condition', 'heave', 'blowout', 'Blanket Theory', 'seepage analysis']
responsiblePersonName: Tim O'Leary
responsiblePersonNumber: (502) 315-6599
citationGuide: "T. M. O'Leary, <i>RMC Backward Erosion Piping (Initiation) Toolbox Technical Manual</i>, Lakewood, CO: U.S. Army Corps of Engineers, Risk Management Center, 2023. Accessed on <i>{enter current date here}</i>."
---
