...
- <em>&gamma;<sub>sat</sub></em> = saturated unit weight of the landside blanket
...
- <em>i<sub>v</sub></em> = vertical seepage exit gradient
...
<Equation
  ...
  equation="\sigma_{FS_{vg}} = \sqrt{Var[FS_{vg}]}"
/>
...
<Equation
  ...
  equation="P(FS_{vg}<1) = \Phi(-\beta_ln(FS_{vg}))"
/>
