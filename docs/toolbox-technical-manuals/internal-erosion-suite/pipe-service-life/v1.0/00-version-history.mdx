...
<TableVersionHistory
  versions={['1.0']}
  dates={['March 2026']}
  descriptions={['Initial release as a web document. Source document is RMC-CPD-2023-11. Modified, reviewed, and approved by represent the author, reviewer, and approver of the source document.']}
