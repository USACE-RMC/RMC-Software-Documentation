...
<FigureInline src="figures\toolbox-technical-manuals\internal-erosion-suite\pipe-service-life\v1.0/inline-images/inline-46117900.png" />

<Figure
  figKey="figure-1"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\pipe-service-life\v1.0\figures\figure1.png"
...
<Figure
  figKey="figure-2"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\pipe-service-life\v1.0\figures\figure2.png"
...
worksheet. Tailwater may be required to calculate the net hydraulic head and hydraulic gradient. Specify the elevation datum by selecting one of three
 options from the drop-down list: ft-NAVD88, ft-NGVD29, and Other. The two datum selections include English units of length (feet). If Other, provide
a user-specified datum along with feet (e.g., ft-MSL [Mean Sea Level]). <FigReference figKey="figure-3" /> through <FigReference figKey="figure-5" />
 illustrate the three possible scenarios.

<Figure
  figKey="figure-3"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\pipe-service-life\v1.0\figures\figure3.png"
...
<Figure
  figKey="figure-4"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\pipe-service-life\v1.0\figures\figure4.png"
...
<Figure
  figKey="figure-5"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\pipe-service-life\v1.0\figures\figure5.png"
...
<Figure
  figKey="figure-6"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\pipe-service-life\v1.0\figures\figure6.png"
...
<Figure
  figKey="figure-7"
  src="figures\toolbox-technical-manuals\internal-erosion-suite\pipe-service-life\v1.0\figures\figure7.png"
