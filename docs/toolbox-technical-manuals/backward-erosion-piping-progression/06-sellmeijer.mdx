...
For deterministic and probabilistic analyses, cells with _FS_ less than 1 have an orange background. <FigReference parentDocId="108" figKey="sellmeijer-deterministic-tabular-output"/>
