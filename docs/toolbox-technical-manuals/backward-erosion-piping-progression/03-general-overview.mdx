...
message bar will vary depending on the computer’s settings and installed add-ins. <FigReference parentDocId="108" figKey="enable-macros"></FigReference> displays examples of different wordings that may appear in the message bar.

<Figure
  parentDocId="108"
  docId="03-general-overview.mdx"
  figKey="enable-macros"
  src={addBaseUrl("/figures/toolbox-technical-manuals/backward-erosion-piping-progression/figure1.png")}
...
title in case multiple copies of the worksheet are created for different analysis scenarios (<FigReference parentDocId="108" figKey="heading"></FigReference>).
...
<Figure
  ...
  docId="03-general-overview.mdx"
  figKey="heading"
  src={addBaseUrl("/figures/toolbox-technical-manuals/backward-erosion-piping-progression/figure2.png")}
...
a user-specified datum along with feet (e.g., ft-MSL [Mean Sea Level]). <FigReference parentDocId="108" figKey="NAVD88"></FigReference>, <FigReference parentDocId="108" figKey="NGVD29"></FigReference>, and <FigReference parentDocId="108" figKey="datum"></FigReference> illustrate
...
<Figure
  ...
  docId="03-general-overview.mdx"
  figKey="NAVD88"
  src={addBaseUrl("/figures/toolbox-technical-manuals/backward-erosion-piping-progression/figure3.png")}
...
<Figure
  ...
  docId="03-general-overview.mdx"
  figKey="NGVD29"
  src={addBaseUrl("/figures/toolbox-technical-manuals/backward-erosion-piping-progression/figure4.png")}
...
<Figure
  ...
  docId="03-general-overview.mdx"
  figKey="datum"
  src={addBaseUrl("/figures/toolbox-technical-manuals/backward-erosion-piping-progression/figure5.png")}
  alt="Headwater and tailwater input: User-specified datum"
  caption="Headwater and tailwater input: User-specified datum."
></Figure>

Most calculation worksheets break down complex analysis into computational steps following a logical sequence (<FigReference parentDocId="108" figKey="step-banner"></FigReference>). Some simpler
...
are labeled as options (<FigReference parentDocId="108" figKey="option-banner"></FigReference>).

<Figure
  parentDocId="108"
  docId="03-general-overview.mdx"
  figKey="step-banner"
  src={addBaseUrl("/figures/toolbox-technical-manuals/backward-erosion-piping-progression/figure6.png")}
...
<Figure
  ...
  src={addBaseUrl("/figures/toolbox-technical-manuals/backward-erosion-piping-progression/figure7.png")}
