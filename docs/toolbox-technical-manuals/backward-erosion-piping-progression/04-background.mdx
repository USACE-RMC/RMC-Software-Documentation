...
and the adjusted calculation rule of Sellmeijer et al. (2011), in addition to the creep ratio methods of Bligh (1910) and Lane (1935).

Applying these methods correctly requires an understanding of the context from which each method was developed. Robbins and van Beek (2015)
