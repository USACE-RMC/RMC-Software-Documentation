...
$$
FS = \left(\frac{C_D C_L C_S C_K C_γ C_Z C_α i_{\textit{pmt}}}{C_R i_f}\right) \tag{1}
$$
...
laboratory flume tests were not conducted, shown in Equation 2 and <FigReference parentDocId="108" figKey="schmertmann-lab-critical-gradients"/>.
