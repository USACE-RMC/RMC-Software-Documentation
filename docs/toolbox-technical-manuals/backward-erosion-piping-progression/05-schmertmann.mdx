...
$$
FS = \frac{C_D C_L C_S C_K C_γ C_Z C_α i_{\textit{pmt}}}{C_R i_f} \tag{1}
$$
...
be used and No if @RISK is not used. The three possible scenarios are illustrated in <FigReference parentDocId="108" figKey="schmertmann-deterministic"/>
through <FigReference parentDocId="108" figKey="schmertmann-probabilistic-risk"/>.
