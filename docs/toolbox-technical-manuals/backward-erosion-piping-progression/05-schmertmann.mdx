...
the field critical gradient adjusted for pipe path inclination (_i<sub>pα</sub>_) as a function of _α_ for field horizontal critical gradients (_i<sub>po</sub>) of 0.05,
