...
sand (_θ_), and White’s constant (_η_) as illustrated in <span>Loading...</span>. The bedding angle and White’s
...
values. <span>Loading...</span> illustrates the deterministic input.
...
values. <span>Loading...</span> illustrates the probabilistic input without using @RISK.
...
column. <span>Loading...</span> illustrates the probabilistic input using @RISK.
...
horizontal permeability of the fine sand (piping) layer, shown in <span>Loading...</span>, using Equation 17.
...
calculations is the most likely (or mode) value. <span>Loading...</span> illustrates the deterministic
...
values used for subsequent calculations are the most likely (or mode) values. <span>Loading...</span>
...
the minimum, most likely, and maximum values. <span>Loading...</span> illustrates the probabilistic
...
<span>Loading...</span> illustrates the probabilistic input for multi-layer aquifer without using @RISK.
...
distribution entered in the third column. <span>Loading...</span> illustrates the
...
are the mean for the @RISK distribution entered in the third column. <span>Loading...</span>
...
Step 4 calculates the field critical horizontal gradient for BEP progression as illustrated in <span>Loading...</span>.
...
terms from the equation for FR as illustrated in <span>Loading...</span>.
...
two scenarios are illustrated in <span>Loading...</span>
and <span>Loading...</span>.
...
For deterministic and probabilistic analyses, cells with _FS_ less than 1 have an orange background. <span>Loading...</span>
illustrates the deterministic tabular output, and <span>Loading...</span> illustrates the
...
(red shaded line). <span>Loading...</span> illustrates the deterministic graphical output.
...
<span>Loading...</span> illustrates the plot options for this chart. The maximum value for the 
...
background for deterministic analysis. <span>Loading...</span> illustrates the graphical output
...
<span>Loading...</span> illustrates the plot options for this chart. The vertical reference 
