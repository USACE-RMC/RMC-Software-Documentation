...
laboratory flume tests were not conducted, shown in Equation 2 and <span>Loading...</span>.
...
determining ipmt, again relative to the reference values, as shown in <span>Loading...</span>.
...
be used and No if @RISK is not used. The three possible scenarios are illustrated in <span>Loading...</span>
through <span>Loading...</span>.
...
value. <span>Loading...</span> illustrates the deterministic input.
...
values. <span>Loading...</span> illustrates probabilistic input without using @RISK.
...
column. <span>Loading...</span> illustrates the probabilistic input without using @RISK.
...
The remaining input for step 2 addresses pipe path geometry as illustrated in <span>Loading...</span> and
...
in <span>Loading...</span>. In practice, laboratory flume tests are rarely conducted to measure the critical
...
line using Equation 5 as illustrated in <span>Loading...</span>.
...
gradient as illustrated in <span>Loading...</span>. The correction factors for foundation depth, seepage path
...
as illustrated in <span>Loading...</span>. Cells that do not apply have a gray background. If a higher permeability
...
flume. CZ is obtained from two-way linear interpolation using these three curves as illustrated in <span>Loading...</span>.
...
The field horizontal critical gradient is calculated using the above correction factors and Equation 11 as illustrated in <span>Loading...</span>.
...
0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, and 0.50 or greater, as illustrated in <span>Loading...</span>. _i<sub>pα</sub>_ is
...
3D flow, input a user-specified gradient reduction factor (GRF). Cells that do not apply have a gray background. <span>Loading...</span>
and <span>Loading...</span> illustrate the two scenarios.
...
cells with FS less than 1 have an orange background. <span>Loading...</span> illustrates the deterministic
tabular output, and <span>Loading...</span> illustrates the probabilistic tabular output without using @RISK.
...
<span>Loading...</span> illustrates the deterministic graphical output.
...
<span>Loading...</span> illustrates the plot options this chart. The maximum value for the primary 
...
for both the deterministic and probabilistic methods as illustrated in <span>Loading...</span>
and <span>Loading...</span>, respectively. The mean probability of BEP progression is plotted as a
...
level using dashed lines, as shown in <span>Loading...</span>.
...
<span>Loading...</span> illustrates the plot options for the charts 
in <span>Loading...</span> and 
<span>Loading...</span>. The vertical reference elevations and minimum and maximum values for the 
x-axis (headwater level) are the same as <span>Loading...</span>. Only the maximum value for the y-axis 
