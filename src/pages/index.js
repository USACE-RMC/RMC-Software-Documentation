...
export default function Home() {
  const homepageData = [
    ...
    },
    {
      ...
      doc_name: 'Toolboxes',
      contentCardData: [
        { IconComponent: InternalErosionIcon, title: 'Internal Erosion Suite', description: 'Internal erosion failure mode assessment', href: addBaseUrl('toolboxes/internal-erosion-suite'), active: true },
        { IconComponent: OvertoppingIcon, title: 'Overtopping Suite', description: 'Overtopping erosion failure mode assessment', href: addBaseUrl('toolboxes/overtopping-suite'), active: true },
        { IconComponent: RiskCalculationsIcon, title: 'Risk Calculations Suite', description: 'Risk computations for dam and levee safety', href: addBaseUrl('toolboxes/risk-calculations-suite'), active: true },
        { IconComponent: SeismicHazardIcon, title: 'Seismic Hazard Suite', description: 'Seismic hazard and failure mode assessment', href: addBaseUrl('toolboxes/seismic-hazard-suite'), active: true },
        { IconComponent: RiverineErosionIcon, title: 'Riverine Erosion Toolbox', description: 'Breach risk from waterside surface erosion', href: addBaseUrl('toolboxes/riverine-erosion-suite'), active: false },
        { IconComponent: SpillwayErosionIcon, title: 'Spillway Erosion Suite', description: 'Spillway erosion failure mode assessment', href: addBaseUrl('toolboxes/spillway-erosion-suite'), active: false },
        { IconComponent: StructuralIcon, title: 'Structural Suite', description: 'Seismic sliding and structural reliability', href: addBaseUrl('toolboxes/structural-suite'), active: false },
      ],
    },
    {
      ...
      contentCardData: [
        { IconComponent: RRFTIcon, title: 'RRFT', description: 'Rapid risk framework', href: addBaseUrl('web-applications/rrft'), active: false },
        { IconComponent: LSTIcon, title: 'Levee Screening Tool', description: 'Levee risk screening and assessment', href: addBaseUrl('web-applications/lst'), active: true },
        { IconComponent: DSTIcon, title: 'Dam Screening Tool', description: 'Dam risk screening', href: addBaseUrl('web-applications/dst'), active: false },
      ],
    },
  ];
