...
export default function Home() {
  const totalRiskData = [
    {
      ...
      doc_location: "/docs/rmc-totalrisk/user-guide",
      doc_name: "RMC-TotalRisk User's Guide",
      active: true,
    },
    {
      icon: "/img/TotalRisk.png",
      doc_location: "/docs/rmc-totalrisk/applications-guide",
      doc_name: "RMC-TotalRisk Applications Guide",
      active: true,
    },
    {
      icon: "/img/TotalRisk.png",
      doc_location: "/docs/rmc-totalrisk/verification-report",
  ...
  const RFAData = [
    {
      icon: "img/RFA.png",
      doc_location: "/docs/rmc-rfa/user-guide",
  ...
  const bestFitData = [
    {
      ...
      doc_location: "/docs/rmc-bestfit/user-guide",
  ...
  const lifeSimData = [
    {
      ...
      doc_location: "/docs/lifesim/users-guide",
  ...
  const toolboxSuiteData = [
    {
      ...
      doc_location: "/ibreach-parameters-suite",
      doc_name: "Breach Parameters Suite",
      active: false,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/flood-hazard-suite",
      doc_name: "Flood Hazard Suite",
      active: false,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/internal-erosion-suite",
      doc_name: "Internal Erosion Suite",
      active: true,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/overtopping-erosion-suite",
      doc_name: "Overtopping Erosion Suite",
      active: false,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/risk-calculations-suite",
      doc_name: "Risk Calculations Suite",
      active: false,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/riverine-erosion-suite",
      doc_name: "Riverine Erosion Toolbox",
      active: false,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/hydraulic-fracture-toolbox",
      doc_name: "Hydraulic Fracture Toolbox",
      active: false,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/rmc-qracalcs-suite",
      doc_name: "RMC-QRAcalcs",
      active: false,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/seismic-hazard-suite",
      doc_name: "Seismic Hazard Suite",
      active: false,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/spillway-erosion-suite",
      doc_name: "Spillway Erosion Suite",
      active: false,
    },
    {
      icon: "img/Toolbox.png",
      doc_location: "/structural-suite",
